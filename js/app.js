...
const ZASZLO_SVG = (() => {
    const V = 'viewBox="0 0 30 20" shape-rendering="crispEdges"';
    const VS = 'viewBox="0 0 30 20"';   // ívelt elemekhez (simítás kell)
...
function zaszloHtml(orszagKod) {
    ...
    if (!sv) return '';
    return `<span class="flag" role="img" aria-hidden="true">${sv}</span>`;
}
