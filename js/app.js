...
function goToCountry(iso) {
    ...
    if (world) world.pointOfView({ lat: center.lat, lng: center.lng, altitude: 0.35 }, 1600);
...
function setFilter(type, btn) {
    ...
    if (world) world.polygonsData(world.polygonsData());
}
...
function resetToGlobe() {
    ...
    if (world) world.pointOfView({ lat: 20, lng: 0, altitude: 2.2 }, 1400);
}
