 ...
 */
function openRacesMenu()   { szekcioraUgras('races'); }
function openBreedingMenu(){ szekcioraUgras('breeding'); }

function szekcioraUgras(ut) {
    document.querySelectorAll('.dropdown-menu').forEach(m => m.classList.remove('open'));
    window.location.href = '/' + (aktualisNyelv || 'hu') + '/' + ut + '/';
}
