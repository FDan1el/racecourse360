...
function buildPopupHtml(t, meta, orszagKod) {
    ...
    // 2/b. RÉGIÓ: csak a régió NEVE jelenik meg, link nélkül. A regionális
    ...
    const orgSiteText = meta.orgSite ? linkOf(meta.orgSite) : "N/A";
    ...
    const raceOrgRow = meta.raceOrgSite
        ? `<div class="popup-row"><b>${meta.raceOrgLabel || 'Versenyek szervezése'}:</b> ${linkOf(meta.raceOrgSite)}${meta.raceOrgName ? `<span class="popup-sub">${meta.raceOrgName}</span>` : ''}</div>`
        : '';
