...
const trackDatabase = {
    SWE: [
        ...
        { name: "Solvalla", city: "Stockholm", lat: 59.3666, lng: 17.9397, founded: 1927, status: "active", length: 1000, direction: "left", org: "Stockholms Travsällskap / Svensk Travsport", ownSite: "https://www.solvalla.se/", operatorSite: null, operatorName: null, note: "Skandinávia legnagyobb pályája; az Elitloppet otthona" },
        ...
        { name: "Färjestad", city: "Karlstad", lat: 59.4085, lng: 13.5006, founded: 1936, status: "active", length: 1000, direction: "left", org: "Svensk Travsport", ownSite: null, operatorSite: "https://www.travsport.se/", operatorName: "Svensk Travsport", note: "Unionstravet – közös svéd-norvég futam" },
        { name: "Bergsåkers travbana", city: "Sundsvall", lat: 62.4151, lng: 17.2269, founded: 1932, status: "active", length: 1000, direction: "left", org: "Norrlands Travsällskap / Svensk Travsport", ownSite: null, operatorSite: "https://www.travsport.se/", operatorName: "Svensk Travsport", note: "Svédország 3. legrégebbi pályája" },
        ...
        { name: "Tingsrydtravet", city: "Tingsryd", lat: 56.5118, lng: 14.9960, founded: 2003, status: "active", length: 1609, direction: "left", org: "Svensk Travsport", ownSite: null, operatorSite: "https://www.travsport.se/", operatorName: "Svensk Travsport", note: "Svédország egyetlen \"mile\" (1609 m) pályája" },
    ...
    ITA: [
        ...
        { name: "Ippodromo di Stupinigi", city: "Vinovo (Torino)", lat: 44.9785, lng: 7.6121, founded: null, status: "active", length: null, direction: null, org: "HippoGroup Torinese S.p.A.", ownSite: "http://www.ippodromovinovo.it/", operatorSite: "https://www.hippogroup.it/", operatorName: "HippoGroup (országos hálózat)", note: "Piemont vezető ügetőpályája, a Stupinigi-i vadászkastély közelében" },
        ...
        { name: "Ippodromo Paolo Sesto", city: "Taranto", lat: 40.5376, lng: 17.3052, founded: null, status: "inactive", length: null, direction: null, org: "Masaf – Direzione Generale Ippica", ownSite: "https://ippodromopaolosesto.com/", operatorSite: null, operatorName: null, note: "Puglia régió ügetőpályája. STÁTUSZ (2026 nyara): jogi bizonytalanság – a Masaf 2026-ban visszavonta az üzemeltető társaság elismerését, miután a létesítményt végrehajtási árverésen adták el; a helyzet rendeződésétől függően újraindulhat" },
    ...
    NOR: [
        { name: "Bjerke Travbane", city: "Oslo", lat: 59.9409, lng: 10.8104, founded: null, status: "active", length: null, direction: null, org: "Det Norske Travselskap (DNT)", ownSite: null, operatorSite: "https://www.travsport.no/", operatorName: "Det Norske Travselskap (DNT)", note: "Norvégia nemzeti főpályája, évi 100+ versenynappal; itt van a DNT (Det Norske Travselskap, alapítva 1875) központja is. Koncerthelyszínként is használt (pl. AC/DC, Tons of Rock fesztivál)" },
        { name: "Bergen Travpark", city: "Breistein (Bergen)", lat: 60.4847, lng: 5.3858, founded: null, status: "active", length: null, direction: null, org: "Bergen Travpark", ownSite: null, operatorSite: "https://www.travsport.no/", operatorName: "Det Norske Travselskap (DNT)", note: "Nyugat-Norvégia vezető ügetőpályája" },
        { name: "Biri Travbane", city: "Biri", lat: 60.9579, lng: 10.6254, founded: null, status: "active", length: null, direction: null, org: "Biri Travbane", ownSite: null, operatorSite: "https://www.travsport.no/", operatorName: "Det Norske Travselskap (DNT)", note: "Tóparti fekvésű pálya Gjøvik közelében" },
        { name: "Forus Travbane", city: "Stavanger", lat: 58.8911, lng: 5.7254, founded: null, status: "active", length: null, direction: null, org: "Forus Travbane", ownSite: null, operatorSite: "https://www.travsport.no/", operatorName: "Det Norske Travselskap (DNT)", note: "Nyugat-Norvégia (Stavanger-régió) egyetlen ügetőpályája; koncerthelyszínként is működik" },
        { name: "Harstad Travpark", city: "Harstad", lat: 68.7883, lng: 16.4591, founded: null, status: "active", length: null, direction: null, org: "Harstad Travpark", ownSite: null, operatorSite: "https://www.travsport.no/", operatorName: "Det Norske Travselskap (DNT)", note: "Észak-Norvégia egyik pályája, a sarkkörön túl" },
        { name: "Jarlsberg Travbane", city: "Sem (Tønsberg)", lat: 59.2787, lng: 10.3694, founded: null, status: "active", length: null, direction: null, org: "Jarlsberg Travbane", ownSite: null, operatorSite: "https://www.travsport.no/", operatorName: "Det Norske Travselskap (DNT)", note: "Vestfold megye vezető ügetőpályája" },
        { name: "Klosterskogen Travbane", city: "Skien", lat: 59.1903, lng: 9.5992, founded: null, status: "active", length: null, direction: null, org: "AS Klosterskogen Travbane", ownSite: null, operatorSite: "https://www.travsport.no/", operatorName: "Det Norske Travselskap (DNT)", note: "Húsvéti versenyeiről ismert, élénk hangulatú pálya" },
        { name: "Momarken Travbane", city: "Mysen", lat: 59.5691, lng: 11.3340, founded: null, status: "active", length: null, direction: null, org: "Momarken Travbane", ownSite: null, operatorSite: "https://www.travsport.no/", operatorName: "Det Norske Travselskap (DNT)", note: "Kelet-Norvégia (Østfold megye) pályája" },
        { name: "Sørlandets Travpark", city: "Kristiansand", lat: 58.1810, lng: 8.1508, founded: null, status: "active", length: null, direction: null, org: "Sørlandets Travpark AS", ownSite: null, operatorSite: "https://www.travsport.no/", operatorName: "Det Norske Travselskap (DNT)", note: "Dél-Norvégia vezető ügetőpályája" },
        { name: "Leangen Travbane (Varig Orkla Arena)", city: "Trondheim", lat: 63.4300, lng: 10.4711, founded: null, status: "active", length: null, direction: null, org: "Leangen Travbane", ownSite: null, operatorSite: "https://www.travsport.no/", operatorName: "Det Norske Travselskap (DNT)", note: "Közép-Norvégia pályája; itt rendezik évente az Észak-Norvég Ügető Fesztivált (Nord-Norsk Travfestival). Jelenleg szponzori névhasználattal \"Varig Orkla Arena\" néven fut a versenynaptárban" },
    ...
    HUN: [
        { name: "Kincsem Park", city: "Budapest", lat: 47.4972, lng: 19.1218, founded: null, status: "active", length: null, direction: null, org: "Kincsem Nemzeti Kft.", ownSite: null, operatorSite: "https://kincsempark.hu/", operatorName: "Kincsem Park", note: "Magyarország egyetlen aktív, kombinált galopp- és ügetőpályája; mindkét szakágban rendszeres versenynaptárral" }
    ],
    EST: [
    ...
    USA: [
        { name: "Batavia Downs", city: "Batavia, NY", lat: 43.0097, lng: -78.2050, founded: null, status: "active", length: null, direction: null, org: "Western Regional OTB", ownSite: "https://www.bataviadownsgaming.com/live-racing/", operatorSite: null, operatorName: null, note: "Amerika egyik legrégebbi téli versenynaptáras pályája; kaszinóval egybeépítve" },
        ...
        { name: "Harrah's Hoosier Park", city: "Anderson, IN", lat: 40.0694, lng: -85.6408, founded: null, status: "active", length: null, direction: null, org: "Caesars Entertainment", ownSite: "https://www.caesars.com/harrahs-hoosier-park/racing", operatorSite: null, operatorName: null, note: "Indiana állam vezető ügetőpályája, kaszinóval" },
        ...
        { name: "Mohegan Sun Pocono (Pocono Downs)", city: "Wilkes-Barre, PA", lat: 41.2695, lng: -75.8222, founded: null, status: "active", length: null, direction: null, org: "Mohegan Gaming & Entertainment", ownSite: "http://www.poconodowns.com", operatorSite: null, operatorName: null, note: "Pennsylvania északkeleti részének vezető ügetőpályája" },
        ...
        { name: "Northfield Park", city: "Northfield, OH", lat: 41.3485, lng: -81.5243, founded: 1957, status: "active", length: null, direction: null, org: "MTR Gaming Group / Northfield Park Associates", ownSite: "http://www.northfieldpark.com", operatorSite: null, operatorName: null, note: "Cleveland közelében; egyike a legtöbb versenynapot rendező amerikai ügetőpályáknak (gyakorlatilag egész évben)" },
        ...
        { name: "Eldorado Gaming Scioto Downs", city: "Columbus, OH", lat: 39.8395, lng: -82.9974, founded: null, status: "active", length: null, direction: null, org: "Caesars Entertainment", ownSite: "https://www.caesars.com/scioto-downs/racing", operatorSite: null, operatorName: null, note: "Ohio állam fővárosának ügetőpályája" },
        ...
        { name: "Yonkers Raceway (Empire City)", city: "Yonkers, NY", lat: 40.9195, lng: -73.8650, founded: 1899, status: "active", length: null, direction: null, org: "MGM Resorts / Empire City Casino", ownSite: "https://empirecitycasino.mgmresorts.com/en/racing.html", operatorSite: null, operatorName: null, note: "Amerika legrégebbi, folyamatosan üzemelő versenypályája (1899 óta) egyes források szerint; New York City közvetlen közelében" }
    ],
    CAN: [
        ...
        { name: "Fraser Downs (Elements Casino Surrey)", city: "Surrey, BC", lat: 49.1123, lng: -122.7293, founded: null, status: "active", length: null, direction: null, org: "Great Canadian Entertainment", ownSite: null, operatorSite: "https://standardbredcanada.ca/content/links-racetracks.html", operatorName: "Standardbred Canada – pályalinkek", note: "British Columbia tartomány ügetőpályája; a Homestretch étterem panorámás kilátással a pályára" },
    ...
    ESP: [
        ...
        { name: "Hipòdrom Torre del Ram", city: "Ciutadella (Menorca)", lat: 40.0112, lng: 3.8022, founded: null, status: "active", length: null, direction: null, org: "Hipòdrom Torre del Ram", ownSite: "http://www.hipodromsantrafel.com/", operatorSite: "https://www.federaciobaleardetrot.com/", operatorName: "Federació Balear de Trot", note: "Menorca nyugati végén; vasárnap esti versenynapok (17:30-21:00), belépés kb. 6 euró, gyerekeknek ingyenes. A nézők a pálya körüli falon ülve követik a futamokat" }
    ],
    BEL: [
    ...
    GBR: [
        ...
        { name: "Corbiewood Stadium", city: "Bannockburn (Stirling), Skócia", lat: 56.0827, lng: -3.9134, founded: null, status: "active", length: null, direction: null, org: "Corbiewood Stadium", ownSite: null, operatorSite: "https://www.trotbritaingb.com/", operatorName: "Trot Britain", note: "Skócia ügetőpályája; a brit ügetősport egyik történelmi központja" }
    ],
    IRL: [
