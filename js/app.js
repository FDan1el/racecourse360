...
const ADATLAP_SZOTAR = {
    hu: { na: "nincs adat", menuTracks: "Pályák", city: "Település", region: "Régió", founded: "Alapítás éve", length: "Pálya hossza", direction: "Irány", dirLeft: "balra", dirRight: "jobbra", surface: "Pálya talaja", ownSite: "Pálya honlapja", operatorSite: "Üzemeltető honlapja", org: "Szervezet", status: "Státusz", stActive: "Aktív", stInactive: "Inaktív / felfüggesztve", stUnknown: "Ismeretlen – ellenőrzendő", stClosed: "Véglegesen bezárt", detailPage: "Részletes adatlap", globeLink: "Megnézem a földgömbön", countries: "Országok", history: "Történelem", historyOf: "ügetősport története", trackWord: "ügetőpálya" },
    en: { na: "no data", menuTracks: "Tracks", city: "Town", region: "Region", founded: "Founded", length: "Track length", direction: "Direction", dirLeft: "left-handed", dirRight: "right-handed", surface: "Track surface", ownSite: "Track website", operatorSite: "Operator website", org: "Organisation", status: "Status", stActive: "Active", stInactive: "Inactive / suspended", stUnknown: "Unknown – to be verified", stClosed: "Permanently closed", detailPage: "Full details", globeLink: "View on the globe", countries: "Countries", history: "History", historyOf: "harness racing history", trackWord: "harness racing track" },
    de: { na: "keine Angabe", menuTracks: "Bahnen", city: "Ort", region: "Region", founded: "Gegründet", length: "Bahnlänge", direction: "Laufrichtung", dirLeft: "linksherum", dirRight: "rechtsherum", surface: "Bahnbelag", ownSite: "Website der Bahn", operatorSite: "Website des Betreibers", org: "Verband", status: "Status", stActive: "Aktiv", stInactive: "Inaktiv / ausgesetzt", stUnknown: "Unbekannt – zu prüfen", stClosed: "Dauerhaft geschlossen", detailPage: "Vollständige Daten", globeLink: "Auf dem Globus ansehen", countries: "Länder", history: "Geschichte", historyOf: "Geschichte des Trabrennsports", trackWord: "Trabrennbahn" },
    fr: { na: "non renseigné", menuTracks: "Hippodromes", city: "Commune", region: "Région", founded: "Fondé en", length: "Longueur de la piste", direction: "Sens de course", dirLeft: "main gauche", dirRight: "main droite", surface: "Nature de la piste", ownSite: "Site de l'hippodrome", operatorSite: "Site de l'exploitant", org: "Organisation", status: "Statut", stActive: "En activité", stInactive: "Inactif / suspendu", stUnknown: "Inconnu – à vérifier", stClosed: "Définitivement fermé", detailPage: "Fiche détaillée", globeLink: "Voir sur le globe", countries: "Pays", history: "Histoire", historyOf: "histoire du trot", trackWord: "hippodrome de trot" },
    sv: { na: "uppgift saknas", menuTracks: "Banor", city: "Ort", region: "Region", founded: "Grundad", length: "Banlängd", direction: "Löpriktning", dirLeft: "vänster", dirRight: "höger", surface: "Banunderlag", ownSite: "Banans webbplats", operatorSite: "Operatörens webbplats", org: "Organisation", status: "Status", stActive: "Aktiv", stInactive: "Inaktiv / pausad", stUnknown: "Okänd – behöver kontrolleras", stClosed: "Permanent stängd", detailPage: "Fullständig information", globeLink: "Visa på jordgloben", countries: "Länder", history: "Historia", historyOf: "travsportens historia", trackWord: "travbana" },
    es: { na: "sin datos", menuTracks: "Hipódromos", city: "Localidad", region: "Región", founded: "Fundado en", length: "Longitud de la pista", direction: "Sentido de carrera", dirLeft: "a izquierdas", dirRight: "a derechas", surface: "Superficie", ownSite: "Sitio web del hipódromo", operatorSite: "Sitio web del operador", org: "Organización", status: "Estado", stActive: "Activo", stInactive: "Inactivo / suspendido", stUnknown: "Desconocido – por verificar", stClosed: "Cerrado definitivamente", detailPage: "Ficha completa", globeLink: "Ver en el globo", countries: "Países", history: "Historia", historyOf: "historia del trote", trackWord: "hipódromo de trote" },
    it: { na: "dato non disponibile", menuTracks: "Ippodromi", city: "Località", region: "Regione", founded: "Fondato nel", length: "Lunghezza della pista", direction: "Senso di marcia", dirLeft: "sinistrorso", dirRight: "destrorso", surface: "Fondo della pista", ownSite: "Sito dell'ippodromo", operatorSite: "Sito del gestore", org: "Organizzazione", status: "Stato", stActive: "Attivo", stInactive: "Inattivo / sospeso", stUnknown: "Sconosciuto – da verificare", stClosed: "Chiuso definitivamente", detailPage: "Scheda completa", globeLink: "Vedi sul globo", countries: "Paesi", history: "Storia", historyOf: "storia del trotto", trackWord: "ippodromo del trotto" },
    ja: { na: "データなし", menuTracks: "競馬場", city: "所在地", region: "地域", founded: "開設年", length: "走路の長さ", direction: "走行方向", dirLeft: "左回り", dirRight: "右回り", surface: "走路面", ownSite: "競馬場の公式サイト", operatorSite: "運営者のサイト", org: "団体", status: "状況", stActive: "開催中", stInactive: "休止中", stUnknown: "不明 – 要確認", stClosed: "閉鎖", detailPage: "詳細データ", globeLink: "地球儀で見る", countries: "国", history: "歴史", historyOf: "繋駕速歩競走の歴史", trackWord: "繋駕速歩競走場" },
    zh: { na: "暂无数据", menuTracks: "赛马场", city: "所在地", region: "地区", founded: "建立年份", length: "赛道长度", direction: "跑行方向", dirLeft: "左转", dirRight: "右转", surface: "赛道地面", ownSite: "赛马场网站", operatorSite: "运营方网站", org: "组织", status: "状态", stActive: "运营中", stInactive: "暂停运营", stUnknown: "未知 – 待核实", stClosed: "已永久关闭", detailPage: "详细资料", globeLink: "在地球仪上查看", countries: "国家", history: "历史", historyOf: "轻驾车赛马历史", trackWord: "轻驾车赛马场" },
    ar: { na: "لا توجد بيانات", menuTracks: "المضامير", city: "البلدة", region: "المنطقة", founded: "سنة التأسيس", length: "طول المضمار", direction: "اتجاه السباق", dirLeft: "يسار", dirRight: "يمين", surface: "أرضية المضمار", ownSite: "موقع المضمار", operatorSite: "موقع المشغّل", org: "الهيئة", status: "الحالة", stActive: "نشط", stInactive: "متوقف مؤقتًا", stUnknown: "غير معروف – قيد التحقق", stClosed: "مغلق نهائيًا", detailPage: "التفاصيل الكاملة", globeLink: "عرض على الكرة الأرضية", countries: "الدول", history: "التاريخ", historyOf: "تاريخ سباق الهرولة", trackWord: "مضمار سباق الهرولة" }
};
...
function buildPopupHtml(t, meta, orszagKod) {
    ...
    /* ================================================================
       ...
       A régi séma szövegei (ui('na'), "nincs saját honlap") szintén
