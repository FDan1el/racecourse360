...
function orszagInfoAblak(iso, esemeny) {
    ...
    doboz.innerHTML = `
        ...
        <div class="oi-name">${meta.name}</div>
...
// FONTOS: 'pointerdown' és NEM 'click'.
//   - A 'click' esemény a WebGL-vászonról (földgömb) nem mindig jut el
//     ide, mert a globe.gl saját eseménykezelője elnyelheti.
//   - Érintőképernyőn a 'click' késleltetve vagy egyáltalán nem érkezik meg.
// A 'pointerdown' egér, érintés és toll esetén egyaránt azonnal lefut,
// és a buborékolás korábbi szakaszában, ezért megbízhatóbb.
// A 'capture: true' garantálja, hogy akkor is megkapjuk, ha valaki
// lentebb megállítaná a terjedést.
document.addEventListener('pointerdown', (esemeny) => {
