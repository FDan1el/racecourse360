...
const trackDatabase = {
    ...
    CAN: [
        ...
        { name: "Century Mile Racetrack and Casino", slug: "century-mile-racetrack-and-casino", city: "Edmonton, AB", region: "AB", lat: 53.3146, lng: -113.5601, founded: null, status: "active", length: 1609, direction: null, org: "Century Casinos", ownSite: "https://www.cnty.com/centurymile", operatorSite: null, operatorName: null, note: "Egy mérföldes pálya az edmontoni repülőtér mellett; a korábbi Northlands Park utódja" },
    ...
    AUS: [
        { name: "Melton Entertainment Park (Tabcorp Park)", slug: "melton-entertainment-park-tabcorp-park", city: "Melton, VIC", region: "VIC", lat: -37.6969, lng: 144.5989, founded: 2009, status: "active", length: 1000, finalStraight: 205, direction: "left", surface: "homok", org: "Harness Racing Victoria", ownSite: "https://meltonentertainmentpark.com.au/racing-overview/", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Victoria állam fő pályája, 2009. július 5-én nyílt meg, felváltva a korábbi Moonee Valley-i pályát. Éttermekkel, szállodával és konferenciaközponttal; az A G Hunter Cup és a Victoria Cup otthona" },
        { name: "Club Menangle (Menangle Park Paceway)", slug: "club-menangle-menangle-park-paceway", city: "Menangle Park, NSW", region: "NSW", lat: -34.1032, lng: 150.7446, founded: 1914, status: "active", length: 1400, finalStraight: 350, direction: "left", surface: "homok", org: "NSW Harness Racing Club", ownSite: "https://www.clubmenangle.com.au/", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Új-Dél-Wales fő pályája; a Miracle Mile Pace otthona, Ausztrália egyik legrangosabb ügetőfutamáé. Az Australian Pacing Gold (APG) három tulajdonos klubjának egyike. 1914-ben GALOPP-pályaként nyílt; a NSW Harness Racing Club 1952-ben vásárolta meg, ügetőpályaként 1953. szeptember 26-án avatták. 2008-ban Tabcorp Parkként újranyitott, 2010-ben vette át a Harold Parktól Sydney fő ügetőpályájának szerepét." },
        { name: "Albion Park Raceway", slug: "albion-park-raceway", city: "Brisbane, QLD", region: "QLD", lat: -27.4393, lng: 153.0465, status: "active", length: 1019, finalStraight: 197, direction: "left", surface: "homok", org: "Albion Park Harness Racing Club", ownSite: "https://www.aphrc.com.au", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Queensland fő pályája; a Blacks A Fake Queensland Championship helyszíne. Az APG három tulajdonos klubjának egyike" },
        { name: "Gloucester Park", slug: "gloucester-park", city: "East Perth, WA", region: "WA", lat: -31.958, lng: 115.8811, status: "active", length: 804, finalStraight: 143, direction: "left", surface: "kőzúzalék", org: "Gloucester Park Harness Racing", ownSite: "https://www.gloucesterpark.com.au/", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Nyugat-Ausztrália fő pályája, Perth belvárosában; a West Australian Derby otthona. Keddi és pénteki versenynapokon ingyenes belépés, családbarát hangulattal" },
        { name: "Globe Derby Park", slug: "globe-derby-park", city: "Adelaide, SA", region: "SA", lat: -34.7964, lng: 138.5914, status: "active", length: 846, finalStraight: 151, direction: "left", surface: "homok", org: "South Australian Trotting Club", ownSite: "https://www.sahrc.com.au/home", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Dél-Ausztrália fő ügetőpályája" },
        { name: "Redcliffe Paceway", slug: "redcliffe-paceway", city: "Redcliffe, QLD", region: "QLD", lat: -27.2311, lng: 153.1072, status: "active", length: 833, finalStraight: 170, direction: "left", surface: "kőzúzalék", org: "Redcliffe Harness Racing Club", ownSite: "https://redcliffehrc.com.au/", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Queensland második legfontosabb pályája; nemrég felújítva" },
        { name: "Bathurst Paceway", slug: "bathurst-paceway", city: "Bathurst, NSW", region: "NSW", lat: -33.4514, lng: 149.5747, status: "active", length: 1065, finalStraight: 186, direction: "left", org: "Bathurst Harness Racing Club", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Az éves Gold Crown sorozat otthona; ingyenes belépés a versenynapokon Műszaki adatok a Harness Racing Australia hivatalos pálya-adatlapjáról (harness.org.au), 2026-08: pályahossz 1065 m, célegyenes 186 m, kanyarsugár 109 m, előzősáv (sprint lane) van." },
        { name: "Newcastle Paceway", slug: "newcastle-paceway", city: "New Lambton, NSW", region: "NSW", lat: -32.9189, lng: 151.7278, status: "active", length: 932, finalStraight: 188, direction: "left", surface: "kőzúzalék", org: "Newcastle Harness Racing Club", ownSite: "https://www.newcastleharness.com.au/", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Új-Dél-Wales egyik regionális központja" },
        { name: "Bendigo Harness Racing Club", slug: "bendigo-harness-racing-club", city: "Junortoun, VIC", region: "VIC", lat: -36.7691, lng: 144.3345, status: "active", length: 1000, finalStraight: 185, direction: "left", surface: "homok", org: "Bendigo Harness Racing Club", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Victoria egyik vezető vidéki pályája; a Red Hot Summer koncertsorozat helyszíne is Műszaki adatok a Harness Racing Australia hivatalos pálya-adatlapjáról (harness.org.au), 2026-08: pályahossz 1000 m, célegyenes 185 m, kanyarsugár 110 m, előzősáv (sprint lane) van." },
        { name: "Ballarat & District Trotting Club", slug: "ballarat-district-trotting-club", city: "Redan (Ballarat), VIC", region: "VIC", lat: -37.5765, lng: 143.8305, founded: 1861, status: "active", length: 1000, finalStraight: 248, direction: "left", surface: "homok", org: "Ballarat & District Trotting Club", ownSite: "https://www.ballarattrottingclub.com.au/", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "A Ballarat and Creswick Trotting Club 1861-ben alakult – ez volt AUSZTRÁLIA ELSŐ, kifejezetten ügetősport népszerűsítésére létrehozott klubja Műszaki adatok a Harness Racing Australia hivatalos pálya-adatlapjáról (harness.org.au), 2026-08: pályahossz 1000 m, célegyenes 248 m, kanyarsugár 80 m, előzősáv (sprint lane) nincs." },
        { name: "Shepparton Harness Racing Club", slug: "shepparton-harness-racing-club", city: "Kialla, VIC", region: "VIC", lat: -36.4475, lng: 145.3892, status: "active", length: 1000, finalStraight: 200, direction: "left", surface: "kőzúzalék", org: "Shepparton Harness Racing Club", ownSite: "https://sheppartonhrc.com.au/", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Victoria északi részének regionális pályája" },
        { name: "Cranbourne Harness Racing Club", slug: "cranbourne-harness-racing-club", city: "Cranbourne, VIC", region: "VIC", lat: -38.118, lng: 145.2801, status: "active", length: 946, finalStraight: 221, direction: "left", surface: "homok", org: "Cranbourne Harness Racing Club", ownSite: "https://www.trotscranbourne.com.au/", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Melbourne délkeleti agglomerációjának pályája Műszaki adatok a Harness Racing Australia hivatalos pálya-adatlapjáról (harness.org.au), 2026-08: pályahossz 946 m, célegyenes 221 m, kanyarsugár 80 m, előzősáv (sprint lane) van." },
        { name: "Pinjarra Paceway", slug: "pinjarra-paceway", city: "Pinjarra, WA", region: "WA", lat: -32.6438, lng: 115.8664, status: "active", length: 1008, finalStraight: 217, direction: "left", surface: "kőzúzalék", org: "Pinjarra Harness Racing Club", ownSite: "http://www.pinjarrapaceway.com.au/", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Nyugat-Ausztrália egyik legnépszerűbb vidéki pályája, hétfői versenynapokkal" },
        { name: "Bunbury Trotting Club", slug: "bunbury-trotting-club", city: "Carey Park (Bunbury), WA", region: "WA", lat: -33.3557, lng: 115.6551, status: "active", length: 960, finalStraight: 205, direction: "left", surface: "kőzúzalék", org: "Bunbury Trotting Club", ownSite: "https://donaldsonpark.com.au/", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Donaldson Park; Nyugat-Ausztrália délnyugati régiójának pályája Műszaki adatok a Harness Racing Australia hivatalos pálya-adatlapjáról (harness.org.au), 2026-08: pályahossz 960 m, célegyenes 205 m, kanyarsugár 87 m, előzősáv (sprint lane) van." },
        { name: "Northam Race Club", slug: "northam-race-club", city: "Northam, WA", region: "WA", lat: -31.64, lng: 116.6999, status: "active", length: 825, finalStraight: 140, direction: "left", surface: "kőzúzalék", org: "Northam Race Club", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "A Northam Cup otthona; Perth-től kb. 1 óra 20 percre" },
        { name: "Mowbray Racecourse", slug: "mowbray-racecourse", city: "Launceston, TAS", region: "TAS", lat: -41.4039, lng: 147.1373, status: "active", length: 1018, finalStraight: 220, direction: "left", surface: "homok", org: "Tasracing", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Tasmania északi részének fő versenypályája" },
        { name: "Elwick Racecourse", slug: "elwick-racecourse", city: "Glenorchy (Hobart), TAS", region: "TAS", lat: -42.8254, lng: 147.2892, status: "active", length: 970, finalStraight: 200, direction: "left", surface: "homok", org: "Tasracing", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Tasmania déli részének fő pályája, a fővárosban" },
        { name: "Devonport Racing Club", slug: "devonport-racing-club", city: "Spreyton, TAS", region: "TAS", lat: -41.212, lng: 146.3388, status: "active", length: 735, finalStraight: 110, direction: "left", surface: "homok", org: "Tasracing", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Minden időjárásban használható pálya; a Devonport Cup otthona Műszaki adatok a Harness Racing Australia hivatalos pálya-adatlapjáról (harness.org.au), 2026-08: pályahossz 735 m, célegyenes 110 m, kanyarsugár 83 m, előzősáv (sprint lane) nincs." },
        { name: "Cowra", slug: "cowra", city: "Cowra, NSW", region: "NSW", lat: -33.83388889, lng: 148.7, status: "active", length: 813, finalStraight: 150, direction: "left", surface: "kőzúzalék", operatorSite: "https://harness.org.au/", operatorName: "Harness Racing Australia", note: "New South Wales állam. A HRA adatlapján elérhető: Circumference (pályahossz), Straights (célegyenes), Radius On Turns (kanyarsugár), Sprint Lane (előzősáv), pontos cím és kapcsolat. Koordináta forrása: OpenStreetMap (Nominatim) + Wikipédia (en) – Cowra. Pálya forrása: Harness Racing Australia hivatalos pályajegyzék (harness.org.au), 2026-08 Műszaki adatok a Harness Racing Australia hivatalos pálya-adatlapjáról (harness.org.au), 2026-08: pályahossz 813 m, célegyenes 150 m, előzősáv (sprint lane) nincs." },
        { name: "Gawler", slug: "gawler", city: "Gawler, SA", region: "SA", lat: -34.59805556, lng: 138.745, status: "active", length: 960, finalStraight: 180, direction: "left", surface: "homok", operatorSite: "https://harness.org.au/", operatorName: "Harness Racing Australia", note: "South Australia állam. A HRA adatlapján elérhető: Circumference (pályahossz), Straights (célegyenes), Radius On Turns (kanyarsugár), Sprint Lane (előzősáv), pontos cím és kapcsolat. Koordináta forrása: OpenStreetMap (Nominatim) + Wikipédia (en) – Gawler. Pálya forrása: Harness Racing Australia hivatalos pályajegyzék (harness.org.au), 2026-08" },
        { name: "Kapunda", slug: "kapunda", city: "Kapunda, SA", region: "SA", lat: -34.33888889, lng: 138.91666667, status: "active", length: 818, direction: "left", surface: "kőzúzalék", operatorSite: "https://harness.org.au/", operatorName: "Harness Racing Australia", note: "South Australia állam. A HRA adatlapján elérhető: Circumference (pályahossz), Straights (célegyenes), Radius On Turns (kanyarsugár), Sprint Lane (előzősáv), pontos cím és kapcsolat. Koordináta forrása: OpenStreetMap (Nominatim) + Wikipédia (en) – Kapunda. Pálya forrása: Harness Racing Australia hivatalos pályajegyzék (harness.org.au), 2026-08" },
        { name: "Port Pirie", slug: "port-pirie", city: "Port Pirie, SA", region: "SA", lat: -33.18583333, lng: 138.01694444, status: "active", length: 950, finalStraight: 170, direction: "left", surface: "kőzúzalék", operatorSite: "https://harness.org.au/", operatorName: "Harness Racing Australia", note: "South Australia állam. A HRA adatlapján elérhető: Circumference (pályahossz), Straights (célegyenes), Radius On Turns (kanyarsugár), Sprint Lane (előzősáv), pontos cím és kapcsolat. Koordináta forrása: OpenStreetMap (Nominatim) + Wikipédia (en) – Port Pirie. Pálya forrása: Harness Racing Australia hivatalos pályajegyzék (harness.org.au), 2026-08" },
        { name: "Bacchus Marsh", slug: "bacchus-marsh", city: "Bacchus Marsh, VIC", region: "VIC", lat: -37.6994, lng: 144.4031, status: "active", length: 802, finalStraight: 200, direction: "left", surface: "homok", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Cím: Bacchus Marsh-Balliang Rd, VIC 3340. Koordináta forrása: OpenStreetMap/Mapcarta ('Bacchus Marsh Racecourse and Recreation Reserve', way 974478305) + Mypacer POI-adatbázis. Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Bankstown Paceway", slug: "bankstown-paceway", city: "Bankstown, NSW", region: "NSW", lat: -33.9327, lng: 151.0083, status: "active", length: 805, finalStraight: 187, direction: "left", ownSite: "https://www.bankstownpaceway.com.au", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Cím: 178 Eldridge Road, Bankstown NSW 2200. Koordináta forrása: Casino City geo-tag + Bing helyi POI-adatbázis (~220 m-en belül). Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Benalla", slug: "benalla", city: "Benalla, VIC", region: "VIC", lat: -36.526, lng: 145.9841, status: "active", length: 1084, finalStraight: 316, direction: "left", surface: "homok", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Cím: Midland Highway, Benalla VIC 3672. Koordináta forrása: Mypacer/OSM-objektum (5809 Midland Hwy) + Facebook-üzletlisting (5835 Midland Hwy, ugyanaz az útszakasz). Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Birchip", slug: "birchip", city: "Birchip, VIC", region: "VIC", lat: -35.9696, lng: 142.928, status: "active", length: 805, direction: "left", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Cím: Berriwillock Road, Birchip VIC 3483 (postai cím: 109 Cummings Ave). Koordináta forrása: Google Places ('Birchip Harness Track') - telefonszám (+61 3 5492 2616) pontosan egyezik a hivatalos adatlappal. A célegyenes és a kanyarsugár a HRA adatlapján N/A. Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Blayney", slug: "blayney", city: "Blayney, NSW", region: "NSW", lat: -33.5185, lng: 149.2605, status: "active", length: 763, finalStraight: 124, direction: "left", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Cím: 27-29 Adelaide Lane, Blayney NSW 2799. PIC-szám (NE045881) alapján azonosítva. KOORDINÁTA MEGERŐSÍTENDŐ: csak 'Blayney Showground' Google-találat érhető el, a cím/telefon nem igazolható vissza rá - térképen ellenőrizendő. Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Boort", slug: "boort", city: "Boort, VIC", region: "VIC", lat: -36.1094, lng: 143.7292, status: "active", length: 712, finalStraight: 151, direction: "left", surface: "kőzúzalék", org: "Boort Trotting Club", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Cím: 35 Malone Street, Boort VIC 3537. Koordináta forrása: Google Places ('Boort Trotting Club', pontos cím-egyezés) + Mypacer/OSM ('Boort Showgrounds', ~150 m-en belül). Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Bridgetown", slug: "bridgetown", city: "Bridgetown, WA", region: "WA", lat: -33.9384, lng: 116.1577, status: "active", length: 814, finalStraight: 164, direction: "left", surface: "kőzúzalék", org: "Bridgetown Harness Racing Club", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Cím: Bridgetown Greater Sports Ground, Les Woodhead Ave, Bridgetown WA 6255. Koordináta forrása: Google Places ('Bridgetown Sports Ground'). FIGYELEM: a Casino City geo-tagje ehhez a pályához gyanúsan azonos hosszúsági fokot adott, mint a Collie-pályához (mindkettő kb. 116.1587 fok), pedig a két város kb. 65 km-re van - ezt a forrást ezért NEM használtuk. Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Broken Hill", slug: "broken-hill", city: "Broken Hill, NSW", region: "NSW", lat: -31.9474, lng: 141.461, status: "active", length: 602, finalStraight: 85, direction: "left", surface: "kőzúzalék", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Cím: Corner Williams & Warnock Streets, Broken Hill NSW 2881 (Rocky Baker Memorial Oval Paceway). PIC-szám: NE050349. Koordináta forrása: Google Places ('Harness Racing In The Hill', pontos cím-egyezés). Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Bulli", slug: "bulli", city: "Bulli, NSW", region: "NSW", lat: -34.3303, lng: 150.9111, status: "active", length: 738, finalStraight: 145, direction: "left", surface: "kőzúzalék", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Cím: PO Box 104, Bulli NSW 2516. KOORDINÁTA MEGERŐSÍTENDŐ: nincs önálló Google-találat 'Bulli Trotting Club'-ra - ez a szomszédos 'Bulli Greyhounds' (Grevillea Park Rd) koordinátája, közös sporttelepet feltételezve (a telefon-előhívó egyezik: 4267). Térképen ellenőrizendő. Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Burnie", slug: "burnie", city: "Wivenhoe, TAS", region: "TAS", lat: -41.0679, lng: 145.9314, status: "active", length: 607, finalStraight: 95, direction: "left", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Cím: 1-7 Pearl Street, Wivenhoe TAS 7320 (Wivenhoe Showground). Koordináta forrása: Google Places ('Burnie Paceway - Harness Racing', pontos cím-egyezés) + második találat ('Burnie Harness Racing Club', ~180 m-en belül). A kanyarsugár a HRA adatlapján N/A. Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Byford", slug: "byford", city: "Byford, WA", region: "WA", lat: -32.2155, lng: 115.9949, status: "active", length: 816, finalStraight: 208, direction: "left", surface: "kőzúzalék", org: "Byford Harness Club", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "EDZŐ- ÉS PRÓBAPÁLYA, nem hagyományos versenypálya: a hivatalos adatlap szerint 'TRIALS 50 SUNDAYS', a létesítmény elsősorban tréning célú (jog track, úszómedence lovaknak, sand track, 100 boksz). Cím: Lot 37 Binshaw Avenue, Byford WA 6122. Koordináta forrása: Google Places ('Byford Trotters Training Complex'). Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Canberra (EPIC)", slug: "canberra-epic", city: "Mitchell, ACT", region: "ACT", lat: -35.2306, lng: 149.1462, status: "active", length: 812, finalStraight: 173, direction: "left", surface: "kőzúzalék", ownSite: "https://capitaltrots.com.au/", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Cím: Exhibition Park in Canberra (EPIC), Flemington Road, Mitchell ACT 2602. PIC-szám: NG750154. Koordináta forrása: Google Places ('Harness Racing ACT', Plover Grandstand) - telefonszám (+61 2 6241 3911) pontosan egyezik a hivatalos adatlappal. Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Carrick Park", slug: "carrick-park", city: "Carrick, TAS", region: "TAS", lat: -41.5358, lng: 147.0121, status: "active", length: 1000, finalStraight: 180, direction: "left", surface: "homok", org: "Carrick Park Pacing Club", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Cím: East Street, Carrick TAS 7291. Koordináta forrása: Google Places ('Carrick Park Pacing Club', pontos cím-egyezés). A kanyarsugár a HRA adatlapján N/A. Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Charlton", slug: "charlton", city: "Charlton, VIC", region: "VIC", lat: -36.2626, lng: 143.3587, status: "active", length: 960, finalStraight: 200, direction: "left", surface: "kőzúzalék", ownSite: "https://charltonpark.com.au/", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Cím: Charlton Park, Mildura Way, Charlton VIC 3525. Koordináta forrása: Google Places ('HRV Charlton') + második találat ('Charlton Harness Racing Track', ~150 m-re) ugyanazon a telepen. Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Cobram", slug: "cobram", city: "Cobram, VIC", region: "VIC", lat: -35.9039, lng: 145.6347, status: "active", length: 1008, finalStraight: 200, direction: "left", surface: "homok", org: "Cobram & District Harness Racing Club", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Cím: Racecourse Road, Cobram VIC 3644. Koordináta forrása: Google Places ('Cobram & District Harness Racing Club') - telefonszám (+61 3 5872 1297) pontosan egyezik a hivatalos adatlappal. Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Collie", slug: "collie", city: "Collie, WA", region: "WA", lat: -33.357, lng: 116.1601, status: "active", length: 644, finalStraight: 135, direction: "left", surface: "kőzúzalék", org: "Collie Harness Racing Club", ownSite: "http://www.collieharnessracingclub.com.au/", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Cím: Bridge St, Collie WA 6225 (Wallsend Paceway). Koordináta forrása: Google Places, pontos cím-egyezés. A Casino City geo-tagje gyanús volt (lásd a Bridgetown-rekord megjegyzését), ezért NEM azt használtuk. A kanyarsugár a HRA adatlapján N/A. Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Coolamon", slug: "coolamon", city: "Coolamon, NSW", region: "NSW", lat: -34.8096, lng: 147.1826, status: "active", length: 1053, finalStraight: 245, direction: "left", surface: "kőzúzalék", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Cím: Darling Street, Coolamon NSW 2701. Koordináta forrása: Google Places ('Coolamon Harness Racing') - telefonszám (+61 427 200 873) pontosan egyezik a hivatalos adatlappal. A kanyarsugár a HRA adatlapján N/A. Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Donald", slug: "donald", city: "Donald, VIC", region: "VIC", lat: -36.3611, lng: 142.9963, status: "active", length: 903, direction: "left", ownSite: "https://country.racing.com/donald", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Cím: Racecourse Road, Donald VIC 3480. Koordináta forrása: Google Places ('Donald Racecourse', pontos cím-egyezés). A célegyenes és a kanyarsugár a HRA adatlapján N/A. Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Dubbo", slug: "dubbo", city: "Dubbo, NSW", region: "NSW", lat: -32.2469, lng: 148.6162, status: "active", length: 805, finalStraight: 121, direction: "left", surface: "kőzúzalék", org: "Dubbo Harness Club", ownSite: "https://www.dubbo.nsw.gov.au/showground", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "Cím: 191 Fitzroy Street, Dubbo Showground, Dubbo NSW 2830. PIC-szám: NJ224985. Koordináta forrása: Google Places ('Dubbo Showground', pontos cím-egyezés). Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Kellerberrin", slug: "kellerberrin", city: "Kellerberrin, WA", region: "WA", lat: -31.6282, lng: 117.712, status: "active", length: 806, finalStraight: 144, direction: "left", surface: "kőzúzalék", operatorSite: "https://www.harness.org.au/", operatorName: "Harness Racing Australia", note: "KÖRZETI KLUB: az adatlapon Cunderdin, Trayning és Merredin kupák is szerepelnek, ezért a pálya pontos hivatalos neve bizonytalan. Cím: Lot 260 Connelly Street, Kellerberrin WA 6410. Koordináta forrása: Google Places ('Kellerberrin & Districts Club', pontos cím-egyezés). A kanyarsugár a HRA adatlapján N/A. Pálya és műszaki adatok forrása: Harness Racing Australia hivatalos pálya-adatlap (harness.org.au), 2026-08." },
        { name: "Albany", slug: "albany", city: "Albany, WA", region: "WA", lat: -34.987101, lng: 117.833229, status: "active", length: 857, finalStraight: 120, direction: "left", surface: "homok", operatorSite: "https://racingwa.com.au/racing/harness-racing", operatorName: "Racing and Wagering Western Australia" },
        { name: "Albury", slug: "albury", city: "Albury, NSW", region: "NSW", lat: -36.064979, lng: 146.935953, status: "active", length: 804, finalStraight: 180, direction: "left", surface: "homok", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" },
        { name: "Ararat", slug: "ararat", city: "Ararat, VIC", region: "VIC", lat: -37.272587, lng: 142.94208, status: "active", length: 811, finalStraight: 186, direction: "left", surface: "homok", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Armidale", slug: "armidale", city: "Armidale, NSW", region: "NSW", lat: -30.517929, lng: 151.675671, status: "active", length: 768, finalStraight: 140, direction: "left", surface: "homok", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" },
        { name: "Busselton", slug: "busselton", city: "Busselton, WA", region: "WA", lat: -33.646806, lng: 115.351012, status: "active", length: 656, finalStraight: 100, direction: "left", surface: "kőzúzalék", operatorSite: "https://racingwa.com.au/racing/harness-racing", operatorName: "Racing and Wagering Western Australia" },
        { name: "Devonport", slug: "devonport", city: "Devonport, TAS", region: "TAS", lat: -41.172442, lng: 146.356105, status: "active", length: 735, finalStraight: 110, direction: "left", surface: "homok", operatorSite: "https://tasracing.com.au/", operatorName: "Tasracing" },
        { name: "Echuca", slug: "echuca", city: "Echuca, VIC", region: "VIC", lat: -36.146913, lng: 144.747849, status: "active", length: 805, finalStraight: 164, direction: "left", surface: "homok", ownSite: "https://www.echucaharnessracingclub.com/", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Elmore", slug: "elmore", city: "Elmore, VIC", region: "VIC", lat: -36.491214, lng: 144.602778, status: "active", length: 800, finalStraight: 200, direction: "left", surface: "homok", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Eugowra", slug: "eugowra", city: "Eugowra, NSW", region: "NSW", lat: -33.434242, lng: 148.384184, status: "active", length: 800, finalStraight: 144, direction: "left", surface: "kőzúzalék", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" },
        { name: "Forbes", slug: "forbes", city: "Forbes, NSW", region: "NSW", lat: -33.387158, lng: 147.997301, status: "active", length: 792, finalStraight: 137, direction: "left", surface: "homok", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" },
        { name: "Geelong", slug: "geelong", city: "Geelong, VIC", region: "VIC", lat: -38.062095, lng: 144.382048, status: "active", length: 960, finalStraight: 200, direction: "left", surface: "homok", ownSite: "https://www.geelonghrc.org.au/", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Goulburn", slug: "goulburn", city: "Goulburn, NSW", region: "NSW", lat: -34.768498, lng: 149.716776, status: "active", length: 1050, finalStraight: 196, direction: "left", surface: "kőzúzalék", ownSite: "https://goulburnpaceway.com.au/", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" },
        { name: "Griffith", slug: "griffith", city: "Griffith, NSW", region: "NSW", lat: -34.261192, lng: 146.054209, status: "active", length: 800, finalStraight: 163, direction: "left", surface: "kőzúzalék", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" },
        { name: "Gunbower", slug: "gunbower", city: "Gunbower, VIC", region: "VIC", lat: -35.954657, lng: 144.39123, status: "active", length: 1239, finalStraight: 273, direction: "left", surface: "homok", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Hamilton", slug: "hamilton", city: "Hamilton, VIC", region: "VIC", lat: -37.746233, lng: 142.086803, status: "active", length: 1000, finalStraight: 185, direction: "left", surface: "kőzúzalék", ownSite: "https://www.hamiltonharnessracing.com.au/", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Horsham", slug: "horsham", city: "Horsham, VIC", region: "VIC", lat: -36.71463, lng: 142.189557, status: "active", length: 1000, finalStraight: 213, direction: "left", surface: "kőzúzalék", ownSite: "https://www.westsidehorsham.com.au/", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Junee", slug: "junee", city: "Junee, NSW", region: "NSW", lat: -34.858079, lng: 147.570971, status: "active", length: 800, finalStraight: 200, direction: "left", surface: "kőzúzalék", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" },
        { name: "Kilmore", slug: "kilmore", city: "Kilmore, VIC", region: "VIC", lat: -37.291379, lng: 144.961926, status: "active", length: 1000, finalStraight: 204, direction: "left", surface: "homok", ownSite: "https://country.racing.com/kilmore", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "King Island", slug: "king-island", city: "King Island, TAS", region: "TAS", lat: -39.908423, lng: 143.855931, status: "active", length: 1570, finalStraight: 220, direction: "left", surface: "fű", operatorSite: "https://tasracing.com.au/", operatorName: "Tasracing" },
        { name: "Kyabram", slug: "kyabram", city: "Kyabram, VIC", region: "VIC", lat: -36.321784, lng: 145.041016, status: "active", length: 790, finalStraight: 195, direction: "left", surface: "homok", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Leeton", slug: "leeton", city: "Leeton, NSW", region: "NSW", lat: -34.559944, lng: 146.403842, status: "active", length: 804, finalStraight: 120, direction: "left", surface: "kőzúzalék", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" },
        { name: "Maitland", slug: "maitland", city: "Maitland, NSW", region: "NSW", lat: -32.745579, lng: 151.561582, status: "active", length: 776, finalStraight: 140, direction: "left", surface: "kőzúzalék", ownSite: "https://maitlandshowground.com.au/msevents/harness-racing/", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" },
        { name: "Marburg", slug: "marburg", city: "Marburg, QLD", region: "QLD", lat: -27.571852, lng: 152.598559, status: "active", length: 700, finalStraight: 150, direction: "left", surface: "kőzúzalék", ownSite: "https://www.marburgshowsociety.com.au/", operatorSite: "https://www.racingqueensland.com.au/racing", operatorName: "Racing Queensland" },
        { name: "Maryborough", slug: "maryborough", city: "Maryborough, VIC", region: "VIC", lat: -37.039341, lng: 143.795704, status: "active", length: 1000, finalStraight: 210, direction: "left", surface: "homok", ownSite: "https://www.maryboroughharness.com.au/", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Mildura", slug: "mildura", city: "Mildura, VIC", region: "VIC", lat: -34.197141, lng: 142.164907, status: "active", length: 810, finalStraight: 183, direction: "left", surface: "kőzúzalék", ownSite: "https://milduraharness.org.au/", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Mount Gambier", slug: "mount-gambier", city: "Mount Gambier, SA", region: "SA", lat: -37.837986, lng: 140.802024, status: "active", length: 805, direction: "left", surface: "homok", ownSite: "https://mountgambierhrc.com/", operatorSite: "https://satrots.com.au/", operatorName: "Harness Racing South Australia" },
        { name: "Nanango", slug: "nanango", city: "Nanango, QLD", region: "QLD", lat: -26.671005, lng: 151.991659, status: "active", length: 400, direction: "left", surface: "fű", operatorSite: "https://www.racingqueensland.com.au/racing", operatorName: "Racing Queensland" },
        { name: "Narrabri", slug: "narrabri", city: "Narrabri, NSW", region: "NSW", lat: -30.336161, lng: 149.763447, status: "active", length: 805, finalStraight: 135, direction: "left", surface: "homok", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" },
        { name: "Narrogin", slug: "narrogin", city: "Narrogin, WA", region: "WA", lat: -32.928804, lng: 117.173426, status: "active", length: 839, finalStraight: 158, direction: "left", surface: "kőzúzalék", ownSite: "https://www.narroginracing.com.au/", operatorSite: "https://racingwa.com.au/racing/harness-racing", operatorName: "Racing and Wagering Western Australia" },
        { name: "Ouyen", slug: "ouyen", city: "Ouyen, VIC", region: "VIC", lat: -35.073212, lng: 142.323171, status: "active", length: 769, finalStraight: 151, direction: "left", surface: "homok", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Parkes", slug: "parkes", city: "Parkes, NSW", region: "NSW", lat: -33.131413, lng: 148.16591, status: "active", length: 767, finalStraight: 196, direction: "left", surface: "kőzúzalék", ownSite: "https://www.parkesharness.org.au/", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" },
        { name: "Penrith", slug: "penrith", city: "Penrith, NSW", region: "NSW", lat: -33.756156, lng: 150.689487, status: "active", length: 805, finalStraight: 130, direction: "left", surface: "homok", ownSite: "https://www.clubpacewaypenrith.com/harness-racing", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" },
        { name: "Redcliffe (Redcliffe Showgrounds)", slug: "redcliffe-redcliffe-showgrounds", city: "Redcliffe (Redcliffe Showgrounds), QLD", region: "QLD", lat: -27.225681, lng: 153.108683, status: "active", length: 600, direction: "left", surface: "homok", ownSite: "https://www.redcliffeshow.com/", operatorSite: "https://www.racingqueensland.com.au/racing", operatorName: "Racing Queensland" },
        { name: "Riverina Paceway", slug: "riverina-paceway", city: "Riverina Paceway, NSW", region: "NSW", lat: -35.074671, lng: 147.383633, status: "active", length: 1071, finalStraight: 190, direction: "left", surface: "kőzúzalék", ownSite: "https://www.riverinapaceway.com.au/", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" },
        { name: "Robinvale", slug: "robinvale", city: "Robinvale, VIC", region: "VIC", lat: -34.601207, lng: 142.791222, status: "active", length: 718, finalStraight: 126, direction: "left", surface: "homok", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Rockhampton", slug: "rockhampton", city: "Rockhampton, QLD", region: "QLD", lat: -23.377523, lng: 150.524205, status: "active", length: 800, finalStraight: 180, direction: "left", surface: "homok", operatorSite: "https://www.racingqueensland.com.au/racing", operatorName: "Racing Queensland" },
        { name: "Rocklea", slug: "rocklea", city: "Rocklea, QLD", region: "QLD", lat: -27.54848, lng: 153.011988, status: "active", length: 545, finalStraight: 70, direction: "left", surface: "homok", ownSite: "https://www.rockleashowgrounds.com/", operatorSite: "https://www.racingqueensland.com.au/racing", operatorName: "Racing Queensland" },
        { name: "Scottsdale", slug: "scottsdale", city: "Scottsdale, TAS", region: "TAS", lat: -41.157437, lng: 147.512458, status: "active", length: 740, finalStraight: 80, direction: "left", surface: "homok", operatorSite: "https://tasracing.com.au/", operatorName: "Tasracing" },
        { name: "Sebastian", slug: "sebastian", city: "Sebastian, VIC", region: "VIC", lat: -36.590837, lng: 144.185764, status: "active", direction: "left", surface: "kőzúzalék", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "St Arnaud", slug: "st-arnaud", city: "St Arnaud, VIC", region: "VIC", lat: -36.610806, lng: 143.26038, status: "active", length: 805, finalStraight: 150, direction: "left", surface: "kőzúzalék", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Stawell", slug: "stawell", city: "Stawell, VIC", region: "VIC", lat: -37.062979, lng: 142.787094, status: "active", length: 813, finalStraight: 189, direction: "left", surface: "kőzúzalék", ownSite: "https://www.stawellharnessracing.com.au/", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "St Marys", slug: "st-marys", city: "St Marys, TAS", region: "TAS", lat: -41.587016, lng: 148.185241, status: "active", length: 1306, finalStraight: 250, direction: "left", surface: "fű", operatorSite: "https://tasracing.com.au/", operatorName: "Tasracing" },
        { name: "Strathalbyn", slug: "strathalbyn", city: "Strathalbyn, SA", region: "SA", lat: -35.266971, lng: 138.89537, status: "active", length: 805, direction: "left", operatorSite: "https://satrots.com.au/", operatorName: "Harness Racing South Australia" },
        { name: "Swan Hill", slug: "swan-hill", city: "Swan Hill, VIC", region: "VIC", lat: -35.351333, lng: 143.557092, status: "active", length: 1040, finalStraight: 205, direction: "left", surface: "kőzúzalék", ownSite: "https://www.swanhilltrots.com.au/", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Tamworth", slug: "tamworth", city: "Tamworth, NSW", region: "NSW", lat: -31.093766, lng: 150.904245, status: "active", length: 750, finalStraight: 150, direction: "left", surface: "kőzúzalék", ownSite: "https://pacewaytamworth.com.au/", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" },
        { name: "Taree", slug: "taree", city: "Taree, NSW", region: "NSW", lat: -31.903575, lng: 152.462303, status: "active", length: 736, direction: "left", surface: "kőzúzalék", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" },
        { name: "Temora", slug: "temora", city: "Temora, NSW", region: "NSW", lat: -34.439978, lng: 147.524311, status: "active", length: 747, finalStraight: 127, direction: "left", surface: "kőzúzalék", ownSite: "https://www.temoratrottingclub.com.au/", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" },
        { name: "Terang", slug: "terang", city: "Terang, VIC", region: "VIC", lat: -38.228504, lng: 142.945636, status: "active", length: 1000, finalStraight: 200, direction: "left", surface: "kőzúzalék", ownSite: "https://www.teranghr.com.au/", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Toowoomba", slug: "toowoomba", city: "Toowoomba, QLD", region: "QLD", lat: -27.558629, lng: 151.923954, status: "active", length: 804, finalStraight: 180, direction: "left", surface: "kőzúzalék", ownSite: "https://cliffordpark.com.au/toowoomba-turf-club-to-host-harness-racing-from-2026/", operatorSite: "https://www.racingqueensland.com.au/racing", operatorName: "Racing Queensland" },
        { name: "Toowoomba Showgrounds", slug: "toowoomba-showgrounds", city: "Toowoomba Showgrounds", lat: -27.561334, lng: 151.882364, status: "active", length: 600, finalStraight: 120, direction: "left", surface: "kőzúzalék" },
        { name: "Townsville", slug: "townsville", city: "Townsville, QLD", region: "QLD", lat: -19.269231, lng: 146.796806, status: "active", length: 606, finalStraight: 110, direction: "left", surface: "kőzúzalék", operatorSite: "https://www.racingqueensland.com.au/racing", operatorName: "Racing Queensland" },
        { name: "Trayning", slug: "trayning", city: "Trayning, WA", region: "WA", lat: -31.111558, lng: 117.790633, status: "active", direction: "left", surface: "kőzúzalék", operatorSite: "https://racingwa.com.au/racing/harness-racing", operatorName: "Racing and Wagering Western Australia" },
        { name: "Victor Harbor", slug: "victor-harbor", city: "Victor Harbor, SA", region: "SA", lat: -35.516814, lng: 138.621254, status: "active", length: 1000, direction: "left", surface: "kőzúzalék", ownSite: "https://www.vhhrc.com/", operatorSite: "https://satrots.com.au/", operatorName: "Harness Racing South Australia" },
        { name: "Wagga", slug: "wagga", city: "Wagga, NSW", region: "NSW", lat: -35.074797, lng: 147.383765, status: "active", length: 823, finalStraight: 165, direction: "left", surface: "kőzúzalék", ownSite: "https://www.riverinapaceway.com.au/", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" },
        { name: "Wagin", slug: "wagin", city: "Wagin, WA", region: "WA", lat: -33.306942, lng: 117.337467, status: "active", length: 814, finalStraight: 167, direction: "left", surface: "kőzúzalék", operatorSite: "https://racingwa.com.au/racing/harness-racing", operatorName: "Racing and Wagering Western Australia" },
        { name: "Wangaratta", slug: "wangaratta", city: "Wangaratta, VIC", region: "VIC", lat: -36.367883, lng: 146.307929, status: "active", length: 813, finalStraight: 202, direction: "left", surface: "kőzúzalék", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Wanneroo", slug: "wanneroo", city: "Wanneroo, WA", region: "WA", lat: -31.767954, lng: 115.839034, status: "active", direction: "left", surface: "kőzúzalék", operatorSite: "https://racingwa.com.au/racing/harness-racing", operatorName: "Racing and Wagering Western Australia" },
        { name: "Warragul", slug: "warragul", city: "Warragul, VIC", region: "VIC", lat: -38.16859, lng: 145.934698, status: "active", length: 837, finalStraight: 147, direction: "left", surface: "kőzúzalék", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Warrnambool", slug: "warrnambool", city: "Warrnambool, VIC", region: "VIC", lat: -38.394349, lng: 142.465717, status: "active", length: 805, finalStraight: 180, direction: "left", surface: "kőzúzalék", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Warwick", slug: "warwick", city: "Warwick, QLD", region: "QLD", lat: -28.209249, lng: 152.017689, status: "active", length: 1740, direction: "left", surface: "fű", operatorSite: "https://www.racingqueensland.com.au/racing", operatorName: "Racing Queensland" },
        { name: "Wedderburn", slug: "wedderburn", city: "Wedderburn, VIC", region: "VIC", lat: -36.41859, lng: 143.61677, status: "active", length: 805, finalStraight: 178, direction: "left", surface: "kőzúzalék", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "West Wyalong", slug: "west-wyalong", city: "West Wyalong, NSW", region: "NSW", lat: -33.936359, lng: 147.211418, status: "active", length: 804, finalStraight: 175, direction: "left", surface: "kőzúzalék", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" },
        { name: "Whyalla", slug: "whyalla", city: "Whyalla, SA", region: "SA", lat: -33.037993, lng: 137.538237, status: "active", length: 876, direction: "left", surface: "kőzúzalék", operatorSite: "https://satrots.com.au/", operatorName: "Harness Racing South Australia" },
        { name: "Williams", slug: "williams", city: "Williams, WA", region: "WA", lat: -33.031263, lng: 116.877523, status: "active", length: 727, finalStraight: 78, direction: "left", surface: "kőzúzalék", operatorSite: "https://racingwa.com.au/racing/harness-racing", operatorName: "Racing and Wagering Western Australia" },
        { name: "Yarrambat", slug: "yarrambat", city: "Yarrambat, VIC", region: "VIC", lat: -37.62201, lng: 145.132705, status: "active", direction: "left", surface: "kőzúzalék", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "Yarra Valley (Yarra Glen)", slug: "yarra-valley-yarra-glen", city: "Yarra Valley (Yarra Glen), VIC", region: "VIC", lat: -37.65527, lng: 145.384309, status: "active", length: 1000, finalStraight: 180, direction: "left", surface: "kőzúzalék", ownSite: "https://country.racing.com/yarra-valley", operatorSite: "https://www.thetrots.com.au/", operatorName: "Harness Racing Victoria" },
        { name: "York", slug: "york", city: "York, WA", region: "WA", lat: -31.893693, lng: 116.764453, status: "active", length: 667, finalStraight: 96, direction: "left", surface: "kőzúzalék", operatorSite: "https://racingwa.com.au/racing/harness-racing", operatorName: "Racing and Wagering Western Australia" },
        { name: "Young", slug: "young", city: "Young, NSW", region: "NSW", lat: -34.314441, lng: 148.315671, status: "active", length: 787, finalStraight: 184, direction: "left", surface: "kőzúzalék", operatorSite: "https://www.hrnsw.com.au/", operatorName: "Harness Racing NSW" }
    ],
    NZL: [
...
/* ============================================================
   A NYELVVÁLASZTÓ ZÁSZLÓI
   ------------------------------------------------------------
   Az index.html-ben a zászlók helye üres <span class="flag">,
   a rajzot itt tesszük bele. Így nem kell tíz SVG-t kézzel a
   HTML-be másolni, és a földgömb popupjával AZONOS rajzokat
   használjuk – egy forrás, nem két rendszer.

   Nyelv → ország leképezés: a nyelvet a legjellemzőbb zászlóval
   jelöljük, ez a bevett gyakorlat a nyelvválasztókban. */
const NYELV_ZASZLO = {
    en: 'GBR', de: 'DEU', fr: 'FRA', sv: 'SWE', es: 'ESP',
    it: 'ITA', ja: 'JPN', zh: 'CHN', ar: 'SAU', hu: 'HUN'
};

function nyelvZaszlokFeltolt() {
    document.querySelectorAll('#langMenu [data-lang-flag]').forEach(el => {
        const iso = NYELV_ZASZLO[el.getAttribute('data-lang-flag')];
        const sv = iso && ZASZLO_SVG[iso];
        if (sv) el.innerHTML = sv;
    });
}

/* ============================================================
   HIRDETÉSI SÁV VEZÉRLÉSE
   ------------------------------------------------------------
   A sáv szerkezete készen áll (index.html + styles.css), de
   ALAPBÓL REJTETT. Ez a függvény kapcsolja be – jelenleg SENKI
   nem hívja, tudatosan.

   ÉLESÍTÉSKOR két dolog kell:
     1) a hirdetéskód (AdSense vagy affiliate) beillesztése a
        #reklamTartalom elembe,
     2) a reklamSavAktival() meghívása – de CSAK a hozzájárulás
        után (CookieYes: a "hirdetési" kategória elfogadva).

   Miért nem elég a CSS-t átírni: a sáv megjelenése eltolja a
   láblécet, az utasítássávot és a nappal/éjszaka gombot. Ezt a
   --reklam-magassag változó és a body.van-reklam osztály együtt
   oldja meg – ha csak a display-t állítanánk, a sáv RÁTAKARNA
   ezekre az elemekre.
   ============================================================ */
function reklamSavAktival() {
    const sav = document.getElementById('reklamSav');
    if (!sav) return false;

    sav.classList.add('aktiv');
    document.body.classList.add('van-reklam');

    /* A tényleges magasságot MÉRJÜK, nem feltételezzük: a
       hirdetés mérete szolgáltatónként és eszközönként eltér.
       A mért érték alapján tolódnak el a többi elemek. */
    const magassag = Math.ceil(sav.getBoundingClientRect().height);
    document.documentElement.style.setProperty('--reklam-magassag', magassag + 'px');
    return true;
}

function reklamSavRejt() {
    const sav = document.getElementById('reklamSav');
    if (sav) sav.classList.remove('aktiv');
    document.body.classList.remove('van-reklam');
}

/* ============================================================
   PARTNERPROGRAM (affiliate) — a földgömb adatlapján
   ------------------------------------------------------------
   Ugyanaz a logika, mint a statikus oldalakon (generator.mjs),
   de itt is szükség van rá: a látogatók többsége a FÖLDGÖMBÖT
   használja, nem a statikus oldalakat – ez a fő felület.

   ALAPBÓL KIKAPCSOLVA: amíg az azonosító null, a blokk NEM
   jelenik meg. Élesítéskor elég ide beírni az azonosítót.

   FONTOS: ha itt beírod, a generator.mjs-ben is írd át –
   a kettő külön fájlban él, és a két felületnek ugyanazt kell
   mutatnia.

   A partnerkapcsolat jelzése kötelező (uniós fogyasztóvédelem),
   ezért a blokk mindig tartalmazza – nem opcionális elem. */
const PARTNER = {
    bookingAid: null,

    bookingUrl(varos, orszagNev) {
        const q = encodeURIComponent(varos + ', ' + orszagNev);
        return 'https://www.booking.com/searchresults.html?ss=' + q +
               '&aid=' + PARTNER.bookingAid;
    }
};

/* ============================================================
   IDŐZÓNÁK — helyi idő a pályán
   ------------------------------------------------------------
   API NÉLKÜL, nulla hálózati kéréssel. A böngésző beépített
   Intl.DateTimeFormat függvénye bármely IANA-időzónában kiírja a
   helyi időt, és a nyári időszámítást is magától követi.

   Miért nem tárolunk időzónát pályánként: 523 rekordba felvenni
   és karbantartani feleslegesen sok. A legtöbb ország EGYETLEN
   zónában van – ott elég az országkód. Csak a valóban több zónás
   országoknál kell finomítani, és ott is állam/tartomány szinten.

   Ez a tábla a MEGJELENÍTÉST szolgálja, nem adat: ha egy ország
   időzónája megváltozik (előfordul), itt egy sort kell javítani,
   nem 40 rekordot.
   ============================================================ */

/* Egy zónás országok: az országkód elég. */
const ORSZAG_IDOZONA = {
    SWE: 'Europe/Stockholm', FIN: 'Europe/Helsinki', NOR: 'Europe/Oslo',
    DNK: 'Europe/Copenhagen', EST: 'Europe/Tallinn', LTU: 'Europe/Vilnius',
    POL: 'Europe/Warsaw',     CZE: 'Europe/Prague',  SVK: 'Europe/Bratislava',
    HUN: 'Europe/Budapest',   AUT: 'Europe/Vienna',  DEU: 'Europe/Berlin',
    NLD: 'Europe/Amsterdam',  BEL: 'Europe/Brussels', CHE: 'Europe/Zurich',
    ITA: 'Europe/Rome',       SVN: 'Europe/Ljubljana', SRB: 'Europe/Belgrade',
    ROU: 'Europe/Bucharest',  UKR: 'Europe/Kyiv',    MLT: 'Europe/Malta',
    GBR: 'Europe/London',     IRL: 'Europe/Dublin',
    /* Franciaország: a szárazföldi pályák mind Európa/Párizs
       zónában. A tengerentúli területek (DROM-COM) kivételt
       képeznek – azokat a FRA_DROMCOM_IDOZONA kezeli, és a
       palyaIdozona() ELŐBB azt nézi meg. */
    FRA: 'Europe/Paris',
    /* Spanyolország: mind az öt pálya a félszigeten vagy a
       Baleárokon van (Sevilla, Mallorca, Menorca) – ezek egy
       zónában. A Kanári-szigetek külön zóna, de ott nincs pályánk. */
    ESP: 'Europe/Madrid',
    /* Új-Zéland: mind a kilenc pálya a fő szigeteken. A Chatham-
       szigetek külön zóna, de ott nincs pályánk. */
    NZL: 'Pacific/Auckland'
};

/* Több zónás országok: állam/tartomány szintű leképezés.
   A kód a city mező végéről jön ("Batavia, NY"), amit a
   koordinátákkal is összevetettünk. */
const ALLAM_IDOZONA = {
    USA: {
        NY: 'America/New_York', PA: 'America/New_York', NJ: 'America/New_York',
        OH: 'America/New_York', MI: 'America/Detroit',  ME: 'America/New_York',
        DE: 'America/New_York', MD: 'America/New_York', MA: 'America/New_York',
        VA: 'America/New_York', KY: 'America/New_York', IN: 'America/Indiana/Indianapolis',
        IL: 'America/Chicago',  MN: 'America/Chicago',  CA: 'America/Los_Angeles'
    },
    CAN: {
...
/* Egyedi esetek, ahol sem az ország, sem az államkód nem elég.
   A kulcs a pálya SLUGJA – az fagyasztott, tehát stabil hivatkozás. */
const PALYA_IDOZONA = {
    /* Oroszország: a két pálya két különböző zónában van
       (Moszkva UTC+3, Omszk UTC+6). */
    'centralnyj-moskovskij-ippodrom': 'Europe/Moscow',
    'omskij-ippodrom': 'Asia/Omsk'
};

/* Francia tengerentúli területek: a régió DROM-COM, de a
   tényleges zóna a Karib-térségben van (UTC-4), nem Párizsban. */
const FRA_DROMCOM_IDOZONA = {
    'Karukera (Guadeloupe)': 'America/Guadeloupe',
    'Madinina (Martinique)': 'America/Martinique'
};

/**
 * Egy pálya időzónája. Ha nem sikerül megállapítani, null –
 * ilyenkor a helyi időt EGYSZERŰEN NEM jelenítjük meg, nem
 * találgatunk (rossz idő rosszabb, mint semmi idő).
 */
function palyaIdozona(iso, palya) {
    if (!palya) return null;

    // 1. Egyedi eset (slug alapján)
    if (palya.slug && PALYA_IDOZONA[palya.slug]) return PALYA_IDOZONA[palya.slug];

    // 2. Francia tengerentúli
    if (iso === 'FRA' && FRA_DROMCOM_IDOZONA[palya.city]) {
        return FRA_DROMCOM_IDOZONA[palya.city];
    }

    // 3. Állam/tartomány szintű (USA, CAN, AUS)
    const allamTabla = ALLAM_IDOZONA[iso];
    if (allamTabla) {
        const m = String(palya.city || '').match(/,\s*([A-Z]{2,3})\s*$/);
        const kod = m ? m[1] : palya.region;
        if (kod && allamTabla[kod]) return allamTabla[kod];
        return null;   // ismeretlen állam – nem találgatunk
    }

    // 4. Egy zónás ország
    return ORSZAG_IDOZONA[iso] || null;
}

/**
 * A pálya helyi ideje, a felület nyelvén formázva.
 * Üres string, ha az időzóna nem ismert.
 */
function helyiIdoSzoveg(iso, palya) {
    const zona = palyaIdozona(iso, palya);
    if (!zona) return '';
    try {
        return new Intl.DateTimeFormat(aktualisNyelv || 'hu', {
            timeZone: zona,
            hour: '2-digit',
            minute: '2-digit'
        }).format(new Date());
    } catch (e) {
        // Ismeretlen zónanév vagy régi böngésző – csendben kihagyjuk.
        return '';
    }
}

/* ============================================================
   IDŐJÁRÁS AZ ADATLAPON
   ------------------------------------------------------------
   Forrás: MET Norway (Meteorologisk institutt), CC BY 4.0.
   A kérés a saját Workerünkön megy át (/api/idojaras), nem
   közvetlenül – így a látogatók IP-címe nem jut ki, és a válasz
   gyorsítótárazható. Részletek: worker.js.

   MŰKÖDÉS: a popup megnyitásakor indul a lekérés, csak arra az
   EGY pályára. Amíg nem érkezik válasz, a sor nem jelenik meg –
   nem foglal helyet, nem villog. Ha a lekérés nem sikerül, a sor
   egyszerűen elmarad: az időjárás kiegészítés, nem alapadat.

   IKONOK: a MET saját ikonkészletét NEM töltjük le (külön fájlok,
   külön kérések). A jelkódból egyszerű, beágyazott SVG-t
   rajzolunk – ugyanaz az elv, mint a zászlóknál.
   ============================================================ */

/* A MET jelkódjai (pl. "clearsky_day", "lightrain") néhány
   alapkategóriára képezhetők le. A kód elejét vizsgáljuk, mert a
   variánsok (_day, _night, _polartwilight) csak a napszakot
   jelölik, az időjárást nem. */
function idojarasIkon(jel) {
    if (!jel) return '';
    const j = String(jel).toLowerCase();
    const A = 'var(--accent, #D89A5E)';
    const F = '#c9b8a8';
    const sv = (tartalom) =>
        `<svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">${tartalom}</svg>`;

    // Nap
    const nap = `<circle cx="12" cy="12" r="4.5" fill="${A}"/>` +
        [0, 45, 90, 135, 180, 225, 270, 315].map(f => {
            const r = f * Math.PI / 180;
            const x1 = 12 + 7 * Math.cos(r), y1 = 12 + 7 * Math.sin(r);
            const x2 = 12 + 9.5 * Math.cos(r), y2 = 12 + 9.5 * Math.sin(r);
            return `<line x1="${x1.toFixed(1)}" y1="${y1.toFixed(1)}" x2="${x2.toFixed(1)}" y2="${y2.toFixed(1)}" stroke="${A}" stroke-width="1.6" stroke-linecap="round"/>`;
        }).join('');

    const felho = `<path d="M7 17h10a3.4 3.4 0 0 0 .3-6.8A5 5 0 0 0 7.6 11 3.1 3.1 0 0 0 7 17z" fill="${F}"/>`;
    const eso = `<line x1="9" y1="19" x2="8" y2="22" stroke="${A}" stroke-width="1.6" stroke-linecap="round"/>` +
                `<line x1="13" y1="19" x2="12" y2="22" stroke="${A}" stroke-width="1.6" stroke-linecap="round"/>`;
    const ho = `<text x="12" y="22" text-anchor="middle" font-size="8" fill="${F}">❄</text>`;

    if (j.startsWith('clearsky')) return sv(nap);
    if (j.startsWith('fair') || j.startsWith('partlycloudy'))
        return sv(`<circle cx="9" cy="9" r="3.4" fill="${A}"/>` + felho);
    if (j.startsWith('cloudy')) return sv(felho);
    if (j.includes('snow')) return sv(felho + ho);
    if (j.includes('sleet')) return sv(felho + eso + ho);
    if (j.includes('rain') || j.includes('shower')) return sv(felho + eso);
    if (j.includes('fog')) return sv(
        `<line x1="4" y1="10" x2="20" y2="10" stroke="${F}" stroke-width="1.8" stroke-linecap="round"/>` +
        `<line x1="4" y1="14" x2="20" y2="14" stroke="${F}" stroke-width="1.8" stroke-linecap="round"/>` +
        `<line x1="6" y1="18" x2="18" y2="18" stroke="${F}" stroke-width="1.8" stroke-linecap="round"/>`);
    return sv(felho);
}

/** Szélirány nyíl – a MET fokban adja (0 = északról fúj). */
function szelNyil(fok) {
    if (fok === null || fok === undefined) return '';
    /* A nyíl abba az irányba mutat, AMERRE a szél fúj – tehát a
       megadott iránnyal ellentétesen. Ez a meteorológiai
       ábrázolás bevett módja. */
    return `<span class="pw-nyil" style="transform:rotate(${(fok + 180) % 360}deg)">↑</span>`;
}

/**
 * Az időjárás lekérése és beírása a már megnyitott popupba.
 *
 * A popup HTML-je akkor épül fel, amikor a látogató a jelölőre
 * koppint – az adat viszont később érkezik. Ezért a sor üresen,
 * REJTVE kerül be, és ez a függvény tölti fel utólag.
 */
async function idojarastBetolt(el) {
    if (!el || el.dataset.betoltve) return;
    const lat = el.dataset.lat, lng = el.dataset.lng;
    if (!lat || !lng) return;

    /* Megjelöljük, hogy már dolgozunk rajta. A Leaflet ugyanazt a
       popupot újranyithatja anélkül, hogy újraépítené – enélkül
       minden megnyitás új kérést indítana. */
    el.dataset.betoltve = '1';

    let adat;
    try {
        const v = await fetch(`/api/idojaras?lat=${lat}&lon=${lng}`);
        adat = await v.json();
    } catch (e) {
        return;   // csendben elmarad
    }
    if (!adat || adat.hiba || adat.homerseklet === null) return;
    if (!el.isConnected) return;   // a popup közben bezárult

    const reszek = [];
    reszek.push(`<span class="pw-ikon">${idojarasIkon(adat.jel)}</span>`);
    reszek.push(`<span class="pw-fok">${Math.round(adat.homerseklet)}°C</span>`);

    if (adat.szel !== null) {
        reszek.push(
            `<span class="pw-adat">${szelNyil(adat.szelirany)}` +
            `${Math.round(adat.szel)} m/s</span>`
        );
    }
    if (adat.csapadek !== null && adat.csapadek > 0) {
        reszek.push(`<span class="pw-adat pw-eso">${adat.csapadek} mm</span>`);
    }

    el.innerHTML = reszek.join('');
    el.classList.add('van-adat');
}
...
const INFO_SZOTAR = {
    hu: {
        ...
        metForras: "Időjárási adatok: MET Norway"
    },
    en: {
        about: "About us",
        contact: "Contact",
        ...
        metForras: "Weather data: MET Norway"
    },
    de: {
        about: "Über uns",
        contact: "Kontakt",
        ...
        metForras: "Wetterdaten: MET Norway"
    },
    fr: {
        about: "À propos",
        contact: "Contact",
        ...
        metForras: "Données météo : MET Norway"
    },
    sv: {
        about: "Om oss",
        contact: "Kontakt",
        ...
        metForras: "Väderdata: MET Norway"
    },
    es: {
        ...
        metForras: "Datos meteorológicos: MET Norway"
    },
    it: {
        about: "Chi siamo",
        contact: "Contatti",
        ...
        metForras: "Dati meteo: MET Norway"
    },
    ja: {
        about: "私たちについて",
        contact: "お問い合わせ",
    ...
    ar: {
        ...
        metForras: "بيانات الطقس: MET Norway"
    }
};
...
function infoModalFrissit() {
    ...
    if (a) a.innerHTML =
        ...
        `<a href="mailto:${EMAIL_INFO}">${EMAIL_INFO}</a></p>` + forrasSor;

    /* FORRÁSMEGJELÖLÉS
       A MET Norway feltüntetése a CC BY 4.0 licenc FELTÉTELE,
       nem udvariassági kérdés.

       Miért ide és nem (csak) a láblécbe: a földgömb lábléce
       kis képernyőn el van rejtve – ott viszont a látogatók
       többsége van. A "Rólunk" ablak minden eszközön elérhető,
       tehát a feltüntetés ténylegesen megvalósul.

       A statikus oldalak láblécében is szerepel (generator.mjs),
       az ugyanis mindig látszik. */
    const forrasSor =
        `<p style="margin-top:16px;font-size:0.75rem;color:#a89383;">` +
        `<a href="https://www.met.no/" rel="noopener" target="_blank">${info('metForras')}</a>` +
        ` &middot; CC BY 4.0</p>`;
...
const ADATLAP_SZOTAR = {
    hu: { menuTracks: "Pályák", city: "Település", region: "Régió", founded: "Alapítás éve", length: "Pálya hossza", direction: "Irány", dirLeft: "balra", dirRight: "jobbra", surface: "Pálya talaja", ownSite: "Pálya honlapja", operatorSite: "Üzemeltető honlapja", org: "Szervezet", status: "Státusz", stActive: "Aktív", stInactive: "Inaktív / felfüggesztve", stUnknown: "Ismeretlen – ellenőrzendő", stClosed: "Véglegesen bezárt", detailPage: "Megnyitás önálló oldalként", globeLink: "Megnézem a földgömbön", countries: "Országok", history: "Történelem", historyOf: "ügetősport története", trackWord: "ügetőpálya", dirLeftLong: "balkéz (óramutatóval ellentétes)", dirRightLong: "jobbkéz (óramutató szerinti)", sfGrass: "fű", sfSand: "homok", sfCinder: "salak", sfGravel: "zúzalék", sfPozzolana: "puccolán", orgNational: "Országos szervezet", orgRacing: "Versenyek szervezése", orgGeneric: "Versenyszervezet", noOwnSite: "nincs saját honlap", noExact: "nincs pontos adat", trotSince: "ügetőverseny {} óta", na: "nincs adat", oiCount: "dokumentált <b>ügető</b> versenypálya", oiHint1: "A megtekintéshez válassz szakágat:", oiHint2: "kattints fent az <b>Ügető</b> gombra", oiClose: "Bezárás", trackCount: "pálya", menuRaces: "Versenyek", menuBreeding: "Fajtatörténet", toDay: "Váltás világos Földre", toNight: "Váltás éjszakai Földre", hirdetes: "Hirdetés", partnerAjanlat: "Ajánlatok a közelben", partnerJelzes: "Partnerlink – ha ezen keresztül foglalsz, jutalékot kapunk. Neked nem kerül többe.", szallasGomb: "Szállás keresése", helyiIdo: "Helyi idő", szel: "szél", csapadek: "csapadék", idojarasForras: "Időjárás: MET Norway" },
    en: { menuTracks: "Tracks", city: "Town", region: "Region", founded: "Founded", length: "Track length", direction: "Direction", dirLeft: "left-handed", dirRight: "right-handed", surface: "Track surface", ownSite: "Track website", operatorSite: "Operator website", org: "Organisation", status: "Status", stActive: "Active", stInactive: "Inactive / suspended", stUnknown: "Unknown – to be verified", stClosed: "Permanently closed", detailPage: "Open as a standalone page", globeLink: "View on the globe", countries: "Countries", history: "History", historyOf: "harness racing history", trackWord: "harness racing track", dirLeftLong: "left-handed (anti-clockwise)", dirRightLong: "right-handed (clockwise)", sfGrass: "turf", sfSand: "sand", sfCinder: "cinder", sfGravel: "crushed stone", sfPozzolana: "pozzolana", orgNational: "National body", orgRacing: "Racing organiser", orgGeneric: "Racing body", noOwnSite: "no dedicated website", noExact: "no exact data", trotSince: "harness racing since {}", na: "no data", oiCount: "documented <b>harness racing</b> tracks", oiHint1: "Choose a discipline to view them:", oiHint2: "tap the <b>Trotting</b> button above", oiClose: "Close", trackCount: "tracks", menuRaces: "Races", menuBreeding: "Breed history", toDay: "Switch to daylight Earth", toNight: "Switch to night Earth", hirdetes: "Advertisement", partnerAjanlat: "Nearby offers", partnerJelzes: "Partner link – we earn a commission if you book through it. No extra cost to you.", szallasGomb: "Find accommodation", helyiIdo: "Local time", szel: "wind", csapadek: "precip.", idojarasForras: "Weather: MET Norway" },
    de: { menuTracks: "Bahnen", city: "Ort", region: "Region", founded: "Gegründet", length: "Bahnlänge", direction: "Laufrichtung", dirLeft: "linksherum", dirRight: "rechtsherum", surface: "Bahnbelag", ownSite: "Website der Bahn", operatorSite: "Website des Betreibers", org: "Verband", status: "Status", stActive: "Aktiv", stInactive: "Inaktiv / ausgesetzt", stUnknown: "Unbekannt – zu prüfen", stClosed: "Dauerhaft geschlossen", detailPage: "Als eigene Seite öffnen", globeLink: "Auf dem Globus ansehen", countries: "Länder", history: "Geschichte", historyOf: "Geschichte des Trabrennsports", trackWord: "Trabrennbahn", dirLeftLong: "linksherum (gegen den Uhrzeigersinn)", dirRightLong: "rechtsherum (im Uhrzeigersinn)", sfGrass: "Gras", sfSand: "Sand", sfCinder: "Schlacke", sfGravel: "Schotter", sfPozzolana: "Puzzolanerde", orgNational: "Nationaler Verband", orgRacing: "Rennveranstalter", orgGeneric: "Rennverband", noOwnSite: "keine eigene Website", noExact: "keine genauen Angaben", trotSince: "Trabrennen seit {}", na: "keine Angabe", oiCount: "dokumentierte <b>Trabrennbahnen</b>", oiHint1: "Wähle eine Disziplin zur Anzeige:", oiHint2: "oben auf <b>Trab</b> tippen", oiClose: "Schließen", trackCount: "Bahnen", menuRaces: "Rennen", menuBreeding: "Zuchtgeschichte", toDay: "Zur Tag-Ansicht wechseln", toNight: "Zur Nacht-Ansicht wechseln", hirdetes: "Anzeige", partnerAjanlat: "Angebote in der Nähe", partnerJelzes: "Partnerlink – bei Buchung erhalten wir eine Provision. Für Sie ohne Mehrkosten.", szallasGomb: "Unterkunft suchen", helyiIdo: "Ortszeit", szel: "Wind", csapadek: "Nied.", idojarasForras: "Wetter: MET Norway" },
    fr: { menuTracks: "Hippodromes", city: "Commune", region: "Région", founded: "Fondé en", length: "Longueur de la piste", direction: "Sens de course", dirLeft: "main gauche", dirRight: "main droite", surface: "Nature de la piste", ownSite: "Site de l'hippodrome", operatorSite: "Site de l'exploitant", org: "Organisation", status: "Statut", stActive: "En activité", stInactive: "Inactif / suspendu", stUnknown: "Inconnu – à vérifier", stClosed: "Définitivement fermé", detailPage: "Ouvrir en page autonome", globeLink: "Voir sur le globe", countries: "Pays", history: "Histoire", historyOf: "histoire du trot", trackWord: "hippodrome de trot", dirLeftLong: "main gauche (sens antihoraire)", dirRightLong: "main droite (sens horaire)", sfGrass: "herbe", sfSand: "sable", sfCinder: "cendrée", sfGravel: "gravillon", sfPozzolana: "pouzzolane", orgNational: "Organisme national", orgRacing: "Organisateur des courses", orgGeneric: "Organisme de courses", noOwnSite: "pas de site propre", noExact: "donnée exacte inconnue", trotSince: "courses de trot depuis {}", na: "non renseigné", oiCount: "hippodromes de <b>trot</b> documentés", oiHint1: "Choisissez une discipline pour les afficher :", oiHint2: "appuyez sur <b>Trot</b> en haut", oiClose: "Fermer", trackCount: "hippodromes", menuRaces: "Courses", menuBreeding: "Histoire de la race", toDay: "Passer à la Terre de jour", toNight: "Passer à la Terre de nuit", hirdetes: "Publicité", partnerAjanlat: "Offres à proximité", partnerJelzes: "Lien partenaire – nous percevons une commission si vous réservez. Sans surcoût pour vous.", szallasGomb: "Chercher un hébergement", helyiIdo: "Heure locale", szel: "vent", csapadek: "précip.", idojarasForras: "Météo : MET Norway" },
    sv: { menuTracks: "Banor", city: "Ort", region: "Region", founded: "Grundad", length: "Banlängd", direction: "Löpriktning", dirLeft: "vänster", dirRight: "höger", surface: "Banunderlag", ownSite: "Banans webbplats", operatorSite: "Operatörens webbplats", org: "Organisation", status: "Status", stActive: "Aktiv", stInactive: "Inaktiv / pausad", stUnknown: "Okänd – behöver kontrolleras", stClosed: "Permanent stängd", detailPage: "Öppna som egen sida", globeLink: "Visa på jordgloben", countries: "Länder", history: "Historia", historyOf: "travsportens historia", trackWord: "travbana", dirLeftLong: "vänster (moturs)", dirRightLong: "höger (medurs)", sfGrass: "gräs", sfSand: "sand", sfCinder: "slagg", sfGravel: "grus", sfPozzolana: "pozzolan", orgNational: "Nationellt förbund", orgRacing: "Tävlingsarrangör", orgGeneric: "Tävlingsorganisation", noOwnSite: "ingen egen webbplats", noExact: "exakt uppgift saknas", trotSince: "travlopp sedan {}", na: "uppgift saknas", oiCount: "dokumenterade <b>trav</b>banor", oiHint1: "Välj gren för att visa dem:", oiHint2: "tryck på <b>Trav</b> ovan", oiClose: "Stäng", trackCount: "banor", menuRaces: "Lopp", menuBreeding: "Rasens historia", toDay: "Byt till dagsljus", toNight: "Byt till natt", hirdetes: "Annons", partnerAjanlat: "Erbjudanden i närheten", partnerJelzes: "Partnerlänk – vi får provision om du bokar. Ingen extra kostnad för dig.", szallasGomb: "Hitta boende", helyiIdo: "Lokal tid", szel: "vind", csapadek: "nederbörd", idojarasForras: "Väder: MET Norway" },
    es: { menuTracks: "Hipódromos", city: "Localidad", region: "Región", founded: "Fundado en", length: "Longitud de la pista", direction: "Sentido de carrera", dirLeft: "a izquierdas", dirRight: "a derechas", surface: "Superficie", ownSite: "Sitio web del hipódromo", operatorSite: "Sitio web del operador", org: "Organización", status: "Estado", stActive: "Activo", stInactive: "Inactivo / suspendido", stUnknown: "Desconocido – por verificar", stClosed: "Cerrado definitivamente", detailPage: "Abrir como página independiente", globeLink: "Ver en el globo", countries: "Países", history: "Historia", historyOf: "historia del trote", trackWord: "hipódromo de trote", dirLeftLong: "a izquierdas (sentido antihorario)", dirRightLong: "a derechas (sentido horario)", sfGrass: "hierba", sfSand: "arena", sfCinder: "ceniza", sfGravel: "grava", sfPozzolana: "puzolana", orgNational: "Organismo nacional", orgRacing: "Organizador de carreras", orgGeneric: "Organismo de carreras", noOwnSite: "sin sitio propio", noExact: "sin dato exacto", trotSince: "carreras de trote desde {}", na: "sin datos", oiCount: "hipódromos de <b>trote</b> documentados", oiHint1: "Elige una disciplina para verlos:", oiHint2: "pulsa <b>Trote</b> arriba", oiClose: "Cerrar", trackCount: "pistas", menuRaces: "Carreras", menuBreeding: "Historia de la raza", toDay: "Cambiar a la Tierra diurna", toNight: "Cambiar a la Tierra nocturna", hirdetes: "Publicidad", partnerAjanlat: "Ofertas cercanas", partnerJelzes: "Enlace de afiliado – recibimos una comisión si reservas. Sin coste adicional para ti.", szallasGomb: "Buscar alojamiento", helyiIdo: "Hora local", szel: "viento", csapadek: "precip.", idojarasForras: "Meteorología: MET Norway" },
    it: { menuTracks: "Ippodromi", city: "Località", region: "Regione", founded: "Fondato nel", length: "Lunghezza della pista", direction: "Senso di marcia", dirLeft: "sinistrorso", dirRight: "destrorso", surface: "Fondo della pista", ownSite: "Sito dell'ippodromo", operatorSite: "Sito del gestore", org: "Organizzazione", status: "Stato", stActive: "Attivo", stInactive: "Inattivo / sospeso", stUnknown: "Sconosciuto – da verificare", stClosed: "Chiuso definitivamente", detailPage: "Apri come pagina autonoma", globeLink: "Vedi sul globo", countries: "Paesi", history: "Storia", historyOf: "storia del trotto", trackWord: "ippodromo del trotto", dirLeftLong: "sinistrorso (antiorario)", dirRightLong: "destrorso (orario)", sfGrass: "erba", sfSand: "sabbia", sfCinder: "scoria", sfGravel: "pietrisco", sfPozzolana: "pozzolana", orgNational: "Ente nazionale", orgRacing: "Organizzatore delle corse", orgGeneric: "Organismo delle corse", noOwnSite: "nessun sito proprio", noExact: "dato esatto non disponibile", trotSince: "corse al trotto dal {}", na: "dato non disponibile", oiCount: "ippodromi del <b>trotto</b> documentati", oiHint1: "Scegli una disciplina per visualizzarli:", oiHint2: "tocca <b>Trotto</b> in alto", oiClose: "Chiudi", trackCount: "piste", menuRaces: "Corse", menuBreeding: "Storia della razza", toDay: "Passa alla Terra diurna", toNight: "Passa alla Terra notturna", hirdetes: "Pubblicità", partnerAjanlat: "Offerte nelle vicinanze", partnerJelzes: "Link partner – riceviamo una commissione se prenoti. Nessun costo aggiuntivo per te.", szallasGomb: "Cerca alloggio", helyiIdo: "Ora locale", szel: "vento", csapadek: "precip.", idojarasForras: "Meteo: MET Norway" },
    ja: { menuTracks: "競馬場", city: "所在地", region: "地域", founded: "開設年", length: "走路の長さ", direction: "走行方向", dirLeft: "左回り", dirRight: "右回り", surface: "走路面", ownSite: "競馬場の公式サイト", operatorSite: "運営者のサイト", org: "団体", status: "状況", stActive: "開催中", stInactive: "休止中", stUnknown: "不明 – 要確認", stClosed: "閉鎖", detailPage: "単独ページで開く", globeLink: "地球儀で見る", countries: "国", history: "歴史", historyOf: "繋駕速歩競走の歴史", trackWord: "繋駕速歩競走場", dirLeftLong: "左回り（反時計回り）", dirRightLong: "右回り（時計回り）", sfGrass: "芝", sfSand: "砂", sfCinder: "シンダー", sfGravel: "砕石", sfPozzolana: "ポッツォラーナ", orgNational: "統括団体", orgRacing: "競走主催", orgGeneric: "競走団体", noOwnSite: "公式サイトなし", noExact: "正確なデータなし", trotSince: "{}年から繋駕速歩競走", na: "データなし", oiCount: "件の<b>繋駕速歩競走</b>場を収録", oiHint1: "表示するには競走種別を選んでください：", oiHint2: "上の「<b>速歩</b>」ボタンをタップ", oiClose: "閉じる", trackCount: "場", menuRaces: "レース", menuBreeding: "品種の歴史", toDay: "昼の地球に切り替え", toNight: "夜の地球に切り替え", hirdetes: "広告", partnerAjanlat: "近隣のご案内", partnerJelzes: "アフィリエイトリンク – ご予約時に手数料を受け取ります。追加費用はかかりません。", szallasGomb: "宿泊先を探す", helyiIdo: "現地時刻", szel: "風", csapadek: "降水", idojarasForras: "天気：MET Norway" },
    zh: { menuTracks: "赛马场", city: "所在地", region: "地区", founded: "建立年份", length: "赛道长度", direction: "跑行方向", dirLeft: "左转", dirRight: "右转", surface: "赛道地面", ownSite: "赛马场网站", operatorSite: "运营方网站", org: "组织", status: "状态", stActive: "运营中", stInactive: "暂停运营", stUnknown: "未知 – 待核实", stClosed: "已永久关闭", detailPage: "以独立页面打开", globeLink: "在地球仪上查看", countries: "国家", history: "历史", historyOf: "轻驾车赛马历史", trackWord: "轻驾车赛马场", dirLeftLong: "左转（逆时针）", dirRightLong: "右转（顺时针）", sfGrass: "草地", sfSand: "沙地", sfCinder: "煤渣", sfGravel: "碎石", sfPozzolana: "火山灰", orgNational: "全国机构", orgRacing: "赛事组织", orgGeneric: "赛事机构", noOwnSite: "无独立网站", noExact: "无确切数据", trotSince: "自{}年起举办轻驾车赛马", na: "暂无数据", oiCount: "处已收录的<b>轻驾车赛马</b>场", oiHint1: "请选择赛种以查看：", oiHint2: "点击上方的「<b>快步</b>」按钮", oiClose: "关闭", trackCount: "处", menuRaces: "赛事", menuBreeding: "品种历史", toDay: "切换至白昼地球", toNight: "切换至夜间地球", hirdetes: "广告", partnerAjanlat: "附近推荐", partnerJelzes: "合作链接 – 通过此链接预订我们将获得佣金，您无需额外付费。", szallasGomb: "查找住宿", helyiIdo: "当地时间", szel: "风", csapadek: "降水", idojarasForras: "天气：MET Norway" },
    ar: { menuTracks: "المضامير", city: "البلدة", region: "المنطقة", founded: "سنة التأسيس", length: "طول المضمار", direction: "اتجاه السباق", dirLeft: "يسار", dirRight: "يمين", surface: "أرضية المضمار", ownSite: "موقع المضمار", operatorSite: "موقع المشغّل", org: "الهيئة", status: "الحالة", stActive: "نشط", stInactive: "متوقف مؤقتًا", stUnknown: "غير معروف – قيد التحقق", stClosed: "مغلق نهائيًا", detailPage: "فتح كصفحة مستقلة", globeLink: "عرض على الكرة الأرضية", countries: "الدول", history: "التاريخ", historyOf: "تاريخ سباق الهرولة", trackWord: "مضمار سباق الهرولة", dirLeftLong: "يسار (عكس عقارب الساعة)", dirRightLong: "يمين (مع عقارب الساعة)", sfGrass: "عشب", sfSand: "رمل", sfCinder: "خبث", sfGravel: "حصى", sfPozzolana: "البوزولانا", orgNational: "الهيئة الوطنية", orgRacing: "منظّم السباقات", orgGeneric: "هيئة السباقات", noOwnSite: "لا يوجد موقع خاص", noExact: "لا توجد بيانات دقيقة", trotSince: "سباقات الهرولة منذ {}", na: "لا توجد بيانات", oiCount: "مضمار <b>هرولة</b> موثق", oiHint1: "اختر نوع السباق لعرضها:", oiHint2: "اضغط زر <b>الهرولة</b> بالأعلى", oiClose: "إغلاق", trackCount: "مضمار", menuRaces: "السباقات", menuBreeding: "تاريخ السلالة", toDay: "التبديل إلى الأرض نهارًا", toNight: "التبديل إلى الأرض ليلًا", hirdetes: "إعلان", partnerAjanlat: "عروض قريبة", partnerJelzes: "رابط شراكة – نحصل على عمولة عند الحجز، دون أي تكلفة إضافية عليك.", szallasGomb: "البحث عن إقامة", helyiIdo: "الوقت المحلي", szel: "رياح", csapadek: "هطول", idojarasForras: "الطقس: MET Norway" }
};
...
/* ÉJSZAKAI TEXTÚRA – közvetlenül, próbálkozás nélkül.
   ------------------------------------------------------------
   Korábban egy "öntesztelő" lánc futott: a gömb a városfények
   NÉLKÜLI earth-dark.jpg-vel indult, közben a háttérben próbálta
   betölteni a városfényes változatot, és csak utólag cserélte le.

   Ez okozta, hogy este megnyitva előbb egy sötét, üres gömb
   fogadta a látogatót, és csak másodpercekkel később (vagy a
   kapcsoló megnyomására) állt helyre a kép.

   A lánc fölösleges volt: az earth-night.jpg LÉTEZIK a
   three-globe csomagban – a projekt saját hivatalos példái is
   ezt használják. Ezért most közvetlenül ezt adjuk meg, és a
   gömb már az első képkockán a helyes textúrával jelenik meg. */
...
function orszagInfoAblak(iso, esemeny) {
    ...
    doboz.innerHTML = `
        <button class="oi-close" onclick="zarOrszagInfo()" aria-label="${ui('oiClose')}">✕</button>
        <div class="oi-name">${orszagNev(iso)}</div>
        <div class="oi-count">🏁 ${szam} ${ui('oiCount')}</div>
        <div class="oi-hint">
            ${ui('oiHint1')}<br>
            ${ui('oiHint2')}
        </div>`;
    ...
    .polygonLabel(({ properties }) => {
        ...
        return `
            <div style="background:rgba(62,35,24,0.97);color:#f0e6dd;padding:10px 14px;
                ...
                <span style="color:#D89A5E;font-size:0.85rem;">🏁 ${count} ${ui('oiCount')}</span>
            </div>
        `;
    })
...
function renderMarkers(iso) {
    ...
    tracks.forEach(t => {
        ...
        marker.bindPopup(buildPopupHtml(t, meta, iso), {
            /* AZ ADATLAP NEM GÖRGETHETŐ – A TÉRKÉP MOZDUL EL.
               ------------------------------------------------------------
               A Leaflet magától lefelé tolja a térképet, hogy a popup
               teljesen elférjen. Korábban viszont a fejléc alá csúszott
               a teteje, mert a Leaflet nem tud a mi rögzített
               fejlécünkről – ő a térkép elemét méri, ami a fejléc
               MÖGÖTT kezdődik.

               Ezért adunk neki felül nagyobb helyet: a 76 pixeles
               fejléc plusz a jelölő fölötti térköz. Így a popup teteje
               a fejléc ALÁ kerül, és a térkép csúszik el annyival,
               amennyi kell.

               A maxHeight SZÁNDÉKOSAN nincs megadva: azzal a popup
               belseje válna görgethetővé, ami rosszabb élmény. */
            autoPan: true,
            autoPanPaddingTopLeft: L.point(14, 96),
            autoPanPaddingBottomRight: L.point(14, 46)
        });

        /* IDŐJÁRÁS – csak a TÉNYLEGESEN megnyitott adatlapnál.
           A bindPopup minden jelölőre lefut, a popupopen viszont
           csak arra, amit a látogató megnyit. Így egy lekérés
           indul, nem 223. */
        marker.on('popupopen', (e) => {
            const doboz = e.popup.getElement();
            if (!doboz) return;
            const el = doboz.querySelector('.popup-idojaras[data-lat]');
            if (el) idojarastBetolt(el);
        });
 ...
 */
/* ============================================================
   ZÁSZLÓK — beágyazott SVG
   ------------------------------------------------------------
   Miért nem emoji: a Windows EGYÁLTALÁN nem jeleníti meg a
   zászló-emojikat (a Segoe UI Emoji nem tartalmazza őket) – ott
   csak a két országbetű látszik: "SE", "US", "GB". Vagyis épp a
   legfontosabb ügetőnemzeteknél tört el a megjelenés.

   Miért nem külső könyvtár: extra hálózati kérés, külső
   függőség és licenckérdés. Ezek a rajzok geometriai formák,
   saját kódból – nincs jogi kötöttség, és offline is működnek.

   Egységes 3:2 arány (viewBox 0 0 30 20), ahogy a zászlóikon-
   készletekben szokás. A shape-rendering="crispEdges" a
   sávhatárokat pixelpontosra igazítja: e nélkül 22 pixel
   szélességen elmosódnának a sávok szélei.
   ============================================================ */

const ZASZLO_SVG = (() => {
    // A width/height ATTRIBUTUM alapertelmezes, nem kotelme: a CSS
    // (.flag svg { width:100%; height:100% }) felul tudja irni.
    // Enelkul, ha a CSS barmi miatt nem ervenyesul, az SVG a
    // szuloelem teljes szelessegere nyulna szet.
    const M = 'width="22" height="15"';
    const V = M + ' viewBox="0 0 30 20" shape-rendering="crispEdges"';
    const VS = M + ' viewBox="0 0 30 20"';   // ívelt elemekhez (simítás kell)

    /** Vízszintes háromsávos */
    const h3 = (a, b, c) =>
        `<svg ${V}><rect width="30" height="20" fill="${b}"/>` +
        `<rect width="30" height="6.667" fill="${a}"/>` +
        `<rect y="13.333" width="30" height="6.667" fill="${c}"/></svg>`;

    /** Vízszintes kétsávos */
    const h2 = (a, b) =>
        `<svg ${V}><rect width="30" height="10" fill="${a}"/>` +
        `<rect y="10" width="30" height="10" fill="${b}"/></svg>`;

    /** Függőleges háromsávos */
    const v3 = (a, b, c) =>
        `<svg ${V}><rect width="30" height="20" fill="${b}"/>` +
        `<rect width="10" height="20" fill="${a}"/>` +
        `<rect x="20" width="10" height="20" fill="${c}"/></svg>`;

    /** Függőleges kétsávos */
    const v2 = (a, b) =>
        `<svg ${V}><rect width="15" height="20" fill="${a}"/>` +
        `<rect x="15" width="15" height="20" fill="${b}"/></svg>`;

    /* Skandináv kereszt.
       A függőleges szár SZÁNDÉKOSAN nem középen van, hanem a
       rúd (bal oldal) felé tolva – ez a skandináv zászlók
       meghatározó vonása. Szár: x 9–13, vízszintes: y 8–12. */
    const kereszt = (hatter, szin, belso) => {
        let sv = `<svg ${V}><rect width="30" height="20" fill="${hatter}"/>` +
                 `<rect x="9" width="4" height="20" fill="${szin}"/>` +
                 `<rect y="8" width="30" height="4" fill="${szin}"/>`;
        if (belso) {   // norvég: a fehér kereszten belül kék
            sv += `<rect x="10" width="2" height="20" fill="${belso}"/>` +
                  `<rect y="9" width="30" height="2" fill="${belso}"/>`;
        }
        return sv + '</svg>';
    };

    /* Union Jack – a brit, ausztrál és új-zélandi zászló alapja.
       Paraméterezhető méretben, hogy kantonként is használható
       legyen. A ferde sávok clipPath-tal maradnak a kereten belül. */
    const unionJack = (sz, ma, id) => {
        const k = `uj${id}`;
        return `<clipPath id="${k}"><rect width="${sz}" height="${ma}"/></clipPath>` +
            `<g clip-path="url(#${k})">` +
            `<rect width="${sz}" height="${ma}" fill="#012169"/>` +
            `<path d="M0,0 L${sz},${ma} M${sz},0 L0,${ma}" stroke="#FFF" stroke-width="${ma * 0.3}"/>` +
            `<path d="M0,0 L${sz},${ma} M${sz},0 L0,${ma}" stroke="#C8102E" stroke-width="${ma * 0.12}"/>` +
            `<path d="M${sz / 2},0 V${ma} M0,${ma / 2} H${sz}" stroke="#FFF" stroke-width="${ma * 0.33}"/>` +
            `<path d="M${sz / 2},0 V${ma} M0,${ma / 2} H${sz}" stroke="#C8102E" stroke-width="${ma * 0.2}"/>` +
            `</g>`;
    };

    /** Ötágú csillag (a déli kereszthez és az USA-hoz) */
    const csillag = (cx, cy, r, szin) => {
        let d = '';
        for (let i = 0; i < 5; i++) {
            const kul = (Math.PI / 180) * (i * 72 - 90);
            const bel = (Math.PI / 180) * (i * 72 - 90 + 36);
            d += (i ? 'L' : 'M') + (cx + r * Math.cos(kul)).toFixed(2) + ',' +
                 (cy + r * Math.sin(kul)).toFixed(2) +
                 'L' + (cx + r * 0.42 * Math.cos(bel)).toFixed(2) + ',' +
                 (cy + r * 0.42 * Math.sin(bel)).toFixed(2);
        }
        return `<path d="${d}Z" fill="${szin}"/>`;
    };
    ...
    return {
        ...
        /* --- Skandináv kereszt --- */
        DNK: kereszt('#C8102E', '#FFFFFF'),
        SWE: kereszt('#006AA7', '#FECC00'),
        FIN: kereszt('#FFFFFF', '#002F6C'),
        NOR: kereszt('#BA0C2F', '#FFFFFF', '#00205B'),

        /* --- Svájc: négyzet alakú, fehér kereszttel.
               A 3:2 keretben középre igazítva, hogy a sorban
               egyforma magas legyen a többivel. --- */
        CHE: `<svg ${V}><rect width="30" height="20" fill="#DA291C"/>` +
             `<rect x="13.4" y="4" width="3.2" height="12" fill="#FFF"/>` +
             `<rect x="9" y="8.4" width="12" height="3.2" fill="#FFF"/></svg>`,

        /* --- Csehország: fehér/piros vízszintes, kék ékkel --- */
        CZE: `<svg ${V}><rect width="30" height="10" fill="#FFFFFF"/>` +
             `<rect y="10" width="30" height="10" fill="#D7141A"/>` +
             `<path d="M0,0 L15,10 L0,20 Z" fill="#11457E"/></svg>`,

        /* --- Egyesült Államok: 13 sáv + csillagos mező.
               A csillagok 22 pixelen pontonként jelennek meg –
               a valódi 50 csillag ott már összemosódna, ezért
               ritkított, de szabályos rácsot rajzolunk. --- */
        USA: (() => {
            let sv = `<svg ${VS} shape-rendering="auto"><rect width="30" height="20" fill="#FFFFFF"/>`;
            for (let i = 0; i < 7; i++) {
                sv += `<rect y="${(i * 20 / 6.5).toFixed(3)}" width="30" height="1.538" fill="#B22234"/>`;
            }
            sv += `<rect width="13" height="10.77" fill="#3C3B6E"/>`;
            for (let s = 0; s < 5; s++) {
                for (let o = 0; o < 5; o++) {
                    const x = 1.6 + o * 2.5 + (s % 2 ? 1.25 : 0);
                    if (x > 12) continue;
                    sv += `<circle cx="${x.toFixed(2)}" cy="${(1.5 + s * 2).toFixed(2)}" r="0.62" fill="#FFF"/>`;
                }
            }
            return sv + '</svg>';
        })(),
        ...
        /* --- Nagy-Britannia --- */
        GBR: `<svg ${VS}>${unionJack(30, 20, 'gb')}</svg>`,

        /* --- Ausztrália: Union Jack kanton + Nemzetközösségi
               csillag + Dél Keresztje --- */
        AUS: `<svg ${VS}><rect width="30" height="20" fill="#012169"/>` +
             `<g transform="translate(0,0)">${unionJack(15, 10, 'au')}</g>` +
             csillag(7.5, 15, 2.4, '#FFF') +
             csillag(24, 4.5, 1.5, '#FFF') +
             csillag(21, 10, 1.5, '#FFF') +
             csillag(25.5, 12.5, 1.5, '#FFF') +
             csillag(27, 8, 1.2, '#FFF') +
             `</svg>`,

        /* --- Új-Zéland: Union Jack kanton + négy piros csillag --- */
        NZL: `<svg ${VS}><rect width="30" height="20" fill="#012169"/>` +
             `<g transform="translate(0,0)">${unionJack(15, 10, 'nz')}</g>` +
             csillag(26, 5, 1.5, '#CC142B') +
             csillag(22, 10.5, 1.5, '#CC142B') +
             csillag(26.5, 14, 1.5, '#CC142B') +
             csillag(21.5, 4.5, 1.3, '#CC142B') +
             `</svg>`,

        /* --- Kanada: piros-fehér-piros + juharlevél.
               A levél stilizált, de a jellegzetes háromkaréjos
               forma és a szár felismerhető marad kis méretben is. --- */
        CAN: `<svg ${VS}><rect width="30" height="20" fill="#FFFFFF"/>` +
             `<rect width="7.5" height="20" fill="#FF0000"/>` +
             `<rect x="22.5" width="7.5" height="20" fill="#FF0000"/>` +
             `<path fill="#FF0000" d="M15 3.2 l1.05 2.1 1.35-.45-.6 2.25 1.8-.6-.45 1.2 2.1.15-1.2 1.35.6.9-2.7.6.15 1.05-2.4-.3.3 2.85h-.9l.3-2.85-2.4.3.15-1.05-2.7-.6.6-.9-1.2-1.35 2.1-.15-.45-1.2 1.8.6-.6-2.25 1.35.45z"/>` +
             `</svg>`,

        /* --- A NYELVVÁLASZTÓHOZ (nem pályaországok) --- */
        JPN: `<svg ${VS}><rect width="30" height="20" fill="#FFFFFF"/>` +
             `<circle cx="15" cy="10" r="6" fill="#BC002D"/></svg>`,

        CHN: (() => {
            let sv = `<svg ${VS}><rect width="30" height="20" fill="#DE2910"/>`;
            sv += csillag(6, 5, 3, '#FFDE00');
            [[11.5,2.2],[13.5,4.2],[13.5,7],[11.5,9]].forEach(([x,y]) =>
                { sv += csillag(x, y, 1.1, '#FFDE00'); });
            return sv + '</svg>';
        })(),

        // Arab nyelv: a szaúdi zászló a bevett jelölés a nyelvválasztókban.
        // Az arab felirat és a kard apró méretben olvashatatlan lenne,
        // ezért egyszerűsített: zöld mező, fehér vízszintes sávval.
        SAU: `<svg ${V}><rect width="30" height="20" fill="#006C35"/>` +
             `<rect x="6" y="8" width="18" height="1.6" fill="#FFF"/>` +
             `<rect x="6" y="11.5" width="13" height="1.2" fill="#FFF"/></svg>`
    };
})();

/**
 * Egy ország zászlaja HTML-ként.
 * Ismeretlen kódnál üres marad – törött ikon soha nem jelenik meg.
 */
function zaszloHtml(orszagKod) {
    const sv = ZASZLO_SVG[orszagKod];
    if (!sv) return '';
    /* A méretet SORKÖZI stílussal is rögzítjük, nemcsak osztállyal.
       Oka: ha a styles.css régi, gyorsítótárazott változata fut (ami
       még nem ismeri az SVG-s .flag szabályt), az osztály önmagában
       nem korlátozná a méretet, és a zászló szétterülne a popupban.
       Így a megjelenés a CSS állapotától függetlenül helyes. */
    return `<span class="flag" role="img" aria-hidden="true"` +
           ` style="display:inline-block;width:22px;height:15px;line-height:0;` +
           `border-radius:2px;overflow:hidden;vertical-align:-2px;` +
           `border:1px solid rgba(0,0,0,0.35);flex-shrink:0;">${sv}</span>`;
}
...
function buildPopupHtml(t, meta, orszagKod) {
    ...
    /* LEKÉPEZÉSI TÁBLA, nem osztás.
       ------------------------------------------------------------
       Az ügetősport TÖRTEKBEN beszél a pályahosszról ("half-mile
       bullring", "11/16 miles"), és ezek nemzetközileg használt,
       angol nyelvű jelölések – nem fordítjuk le őket, ahogy a
       pályaneveket sem. Korábban itt magyar elnevezések álltak
       ("fél mérföld", "öt-nyolcad mérföld"), amik minden nyelven
       magyarul jelentek meg.

       A tűrésalapú közelítés helyett pontos értékek: egy hivatalos
       forrásból származó hossz vagy szerepel a táblában, vagy nem –
       a szkript nem találgat. Ugyanez a tábla van a generátorban is,
       hogy a popup és a statikus adatlap SOHA ne mondjon mást. */
    const MERFOLD_TABLA = {
        402:  '1/4 mile',
        805:  '1/2 mile',
        1006: '5/8 mile',
        // A Century Downs (Alberta) hivatalosan 11/16 mérföldes –
        // a Standardbred Canada pályajegyzéke szerint. Ritka méret,
        // de valós: 11/16 × 1609 = 1106 m.
        1106: '11/16 mile',
        1207: '3/4 mile',
        1408: '7/8 mile',
        1609: '1 mile',
    ...
    function hosszSzoveg(meter, orszagKod) {
        if (!meter) return ui('na');
        if (!MERFOLD_ORSZAGOK.includes(orszagKod)) return `${meter} m`;
        const nev = MERFOLD_TABLA[meter];
        // Ismeretlen érték: méterben írjuk ki – jobb, mint egy
        // kitalált törtet mutatni.
        if (!nev) return `${meter} m`;
        return `${nev} <span class="popup-sub-inline">(${meter} m)</span>`;
    }
    ...
    /* BŐVÍTETT ADATLAP
       ------------------------------------------------------------
       Ezeknél az országoknál a talaj és a régió is megjelenik az
       adatlapon, mert az adatgyűjtés odáig eljutott.

       A lista SZÁNDÉKOSAN nem automatikus (pl. "van-e talaj adat"):
       egy ország akkor kerül ide, ha a feldolgozása LEZÁRULT.
       Így nem fordulhat elő, hogy egy félkész országnál a pályák
       fele bővített, a másik fele nem – az következetlen lenne. */
    const BOVITETT_ADATLAP = ['FRA', 'AUS'];
    ...
    const SURFACE_TEXT = {
        ...
        'salak':     ui('sfCinder'),
        'zúzalék':   ui('sfGravel'),
        // Az ausztrál adatgyűjtés 'kőzúzalék'-ot használ ugyanerre.
        'kőzúzalék': ui('sfGravel'),
    ...
    /* FEJLÉC — MINDEN ORSZÁGBAN AZONOS
       ------------------------------------------------------------
       Korábban kétféle fejléc létezett: a "bővített" országoknál
       (Franciaország stb.) a település a zászló előtt állt, a
       többinél viszont csak a zászló volt a fejlécben, a település
       pedig lejjebb, az első adatsorba került. Ez országonként
       eltérő megjelenést adott ugyanannak az adatlapnak.

       Mostantól egységes: balra a státusz, jobbra a település,
       utána a zászló. Az USA, Ausztrália és Kanada esetében az
       állam/tartomány rövidítése MÁR A city mezőben szerepel
       ("Batavia, NY"), tehát külön összefűzés nem kell. */
    /* PARTNERBLOKK – csak ha az azonosító be van állítva ÉS van
       településnév. Enélkül nem jelenik meg semmi: jobb kihagyni,
       mint egy találat nélküli keresésre küldeni a látogatót. */
    const partnerBlokk = (PARTNER.bookingAid && t.city)
        ? `<div class="popup-row popup-partner">
                    <a href="${PARTNER.bookingUrl(t.city, orszagNev(orszagKod))}"
                       rel="nofollow sponsored noopener" target="_blank">${ui('szallasGomb')} &rsaquo;</a>
                    <span class="popup-partner-jelzes">${ui('partnerJelzes')}</span>
                </div>`
        : '';

    /* HELYI IDŐ – a település alatt, halványan.
       Csak akkor jelenik meg, ha az időzóna ismert. Egyszeri
       érték a popup megnyitásakor; nem "ketyeg", mert a popup
       rövid ideig van nyitva, és egy másodpercenként frissülő
       óra fölöslegesen dolgoztatná a böngészőt. */
    /* HELYI IDŐ + IDŐZÓNA — a kártya jobb felső sarkában.
       Nem kiemelt információ, hanem apró dizájnelem: később ide
       kerül az időjárás is, ugyanebbe a sarokba. Ezért halvány
       és kicsi – nem versenyez a pálya nevével.

       A zóna neve rövidítve jelenik meg (az utolsó szegmens
       aláhúzások nélkül: "America/New_York" → "New York"),
       mert a teljes útvonal a szűk kártyán nem fér el, és a
       városnév amúgy is beszédesebb. */
    const idoSzoveg = helyiIdoSzoveg(orszagKod, t);
    const zonaNev = (() => {
        const z = palyaIdozona(orszagKod, t);
        if (!z) return '';
        return z.split('/').pop().replace(/_/g, ' ');
    })();

    const idoSarok = idoSzoveg
        ? `<span class="popup-ido-sarok">` +
          `<span class="popup-ido">${idoSzoveg}</span>` +
          (zonaNev ? `<span class="popup-zona">${zonaNev}</span>` : '') +
          `</span>`
        : '';

    /* A zászló és alatta az idő EGY oszlopban áll, a fejléc jobb
       szélén. Korábban az idő abszolút pozícióval "lebegett" a
       kártya sarkában, és rálógott a pálya nevére – így viszont
       a saját helyét foglalja, nem takar semmit. */
    const fejlecVege = `<span class="popup-head-right">
                    ${t.city ? `<span class="popup-city">${t.city}</span>` : ''}
                    <span class="popup-flag">${zaszloHtml(orszagKod)}</span>
                </span>`;

    /* IDŐ ÉS IDŐJÁRÁS – közös sor a fejléc alatt.
       Az idő azonnal megvan (számolás, nem lekérés), az időjárás
       később érkezik. Ezért a sor mindig megjelenik, ha van idő,
       és az időjárás-rész utólag töltődik bele.

       Az egyedi azonosító azért kell, mert egyszerre több popup
       is nyitva lehetne – így mindegyik a sajátját tölti fel. */
    const idoSor = idoSzoveg
        ? `<div class="popup-idosor">
                <span class="popup-ido-blokk">
                    <span class="popup-ido">${idoSzoveg}</span>` +
                    (zonaNev ? `<span class="popup-zona">${zonaNev}</span>` : '') +
                `</span>
                <span class="popup-idojaras" data-lat="${t.lat}" data-lng="${t.lng}"></span>
            </div>`
        : '';

    /* A LEKÉRÉS NEM ITT INDUL.
       ------------------------------------------------------------
       A buildPopupHtml MINDEN jelölőre lefut a térkép
       megnyitásakor (bindPopup), nem csak arra, amit a látogató
       megnyit. Ha innen indítanánk a lekérést, Franciaországnál
       egyszerre 223 kérés menne ki a MET felé – ami a
       forgalmi feltételeik megsértése, és letiltáshoz vezetne.

       Ezért a koordináta csak ADATKÉNT kerül az elembe, és a
       tényleges lekérést a 'popupopen' esemény indítja – akkor,
       amikor a látogató ténylegesen megnyit egy adatlapot, és az
       elem már a DOM-ban van. */
    ...
    return `
        <div class="popup-card">
            ...
            <div class="popup-head">
                <span class="popup-head-left">
                    <span class="popup-statuszsor">
...
const translations = {
    hu: { back: "Vissza a földgömbhöz", legalTitle: "Adatvédelem / Impresszum", menu: "Menü", lang: "Nyelv / Language",
          menuTracks: "Pályák", menuHistory: "Történelem", menuRaces: "Versenyek", menuBreeding: "Fajtatörténet", menuAbout: "Rólunk", menuContact: "Kontakt", instruction: "Kapcsold be az Ügető szűrőt a pályákkal rendelkező országok megjelenítéséhez" },
    en: { back: "Back to the globe", legalTitle: "Privacy / Legal", menu: "Menu", lang: "Language",
          menuTracks: "Tracks", menuHistory: "History", menuRaces: "Races", menuBreeding: "Breed history", menuAbout: "About us", menuContact: "Contact", instruction: "Enable the Trotting filter to reveal countries with racecourse data" },
    de: { back: "Zurück zum Globus", legalTitle: "Datenschutz / Impressum", menu: "Menü", lang: "Sprache",
          menuTracks: "Bahnen", menuHistory: "Geschichte", menuRaces: "Rennen", menuBreeding: "Zuchtgeschichte", menuAbout: "Über uns", menuContact: "Kontakt", instruction: "Aktiviere den Trab-Filter, um Länder mit Rennbahndaten anzuzeigen" },
    fr: { back: "Retour au globe", legalTitle: "Confidentialité / Mentions légales", menu: "Menu", lang: "Langue",
          menuTracks: "Hippodromes", menuHistory: "Histoire", menuRaces: "Courses", menuBreeding: "Histoire de la race", menuAbout: "À propos", menuContact: "Contact", instruction: "Activez le filtre Trot pour afficher les pays avec des données" },
    sv: { back: "Tillbaka till jordgloben", legalTitle: "Integritet / Juridisk info", menu: "Meny", lang: "Språk",
          menuTracks: "Banor", menuHistory: "Historia", menuRaces: "Carreras", menuBreeding: "Historia de la raza", menuRaces: "Lopp", menuBreeding: "Rasens historia", menuAbout: "Om oss", menuContact: "Kontakt", instruction: "Aktivera travfiltret för att visa länder med banor" },
    es: { back: "Volver al globo", legalTitle: "Privacidad / Aviso legal", menu: "Menú", lang: "Idioma",
          menuTracks: "Hipódromos", menuHistory: "Historia", menuRaces: "Carreras", menuBreeding: "Historia de la raza", menuAbout: "Sobre nosotros", menuContact: "Contacto", instruction: "Activa el filtro de trote para mostrar los países con datos" },
    it: { back: "Torna al globo", legalTitle: "Privacy / Note legali", menu: "Menu", lang: "Lingua",
          menuTracks: "Ippodromi", menuHistory: "Storia", menuRaces: "Corse", menuBreeding: "Storia della razza", menuAbout: "Chi siamo", menuContact: "Contatti", instruction: "Attiva il filtro Trotto per mostrare i paesi con dati" },
    ja: { back: "地球儀に戻る", legalTitle: "プライバシー / 法的情報", menu: "メニュー", lang: "言語",
          menuTracks: "競馬場", menuHistory: "歴史", menuRaces: "レース", menuBreeding: "品種の歴史", menuAbout: "私たちについて", menuContact: "お問い合わせ", instruction: "「速歩」フィルターをオンにすると、データのある国が表示されます" },
    zh: { back: "返回地球", legalTitle: "隐私 / 法律信息", menu: "菜单", lang: "语言",
          menuTracks: "赛马场", menuHistory: "历史", menuRaces: "赛事", menuBreeding: "品种历史", menuAbout: "关于我们", menuContact: "联系我们", instruction: "开启「快步」筛选以显示有数据的国家" },
    ar: { back: "العودة إلى الكرة الأرضية", legalTitle: "الخصوصية / قانوني", menu: "القائمة", lang: "اللغة",
          menuTracks: "المضامير", menuHistory: "التاريخ", menuRaces: "السباقات", menuBreeding: "تاريخ السلالة", menuAbout: "من نحن", menuContact: "اتصل بنا", instruction: "شغّل مرشح الهرولة لعرض الدول التي تتوفر لها بيانات" }
};
...
function setLanguage(code, btn, isManual = true) {
    ...
    setText('[data-i18n="hirdetes"]', ui('hirdetes'));
    setText('[data-i18n="menuRaces"]', t.menuRaces);
    setText('[data-i18n="menuBreeding"]', t.menuBreeding);
    ...
    // A főmenü linkjei az aktuális nyelvre mutassanak.
    fomenuLinkekFrissit(code);

    // A Pályák panel címe az index.html-ben statikusan "Pályák" –
    // itt írjuk felül, hogy ne kelljen a HTML-t szerkeszteni.
    const panelCim = document.querySelector('#tracksPanel .tp-title');
    if (panelCim) panelCim.textContent = t.menuTracks;

    // Arab nyelvnél jobbról-balra irányítás a fejléc jobb oldali csoportjára
    /* ARAB (jobbról balra író) NYELV
       ------------------------------------------------------------
       ELV: az arab írásirány a SZÖVEGRE vonatkozik, nem a felület
       felépítésére. A logó helye, a gombok sorrendje, a panelek
       elrendezése nyelvfüggetlen – ezeket nem tükrözzük.

       Ezért a felület egésze LTR marad. Az arab szöveg így is
       helyesen, jobbról balra jelenik meg: ezt a böngésző Unicode
       bidi-algoritmusa szövegrészenként automatikusan megoldja,
       nem kell hozzá a konténert megfordítani.

       Kivétel: a Rólunk / Kontakt ablak FOLYÓ SZÖVEGE. Ott több
       bekezdésnyi arab szöveg áll, és a bekezdés-igazítás
       ténylegesen számít az olvashatóság szempontjából. */
    const arab = (code === 'ar');
    document.documentElement.dir = 'ltr';
    document.body.dir = 'ltr';

    document.querySelectorAll('#infoModal .legal-tab-content').forEach(el => {
        el.dir = arab ? 'rtl' : 'ltr';
    });
...
async function detectAndSetLanguage() {
    /* ÉRKEZÉS A NYELVI GYÖKÉRRŐL  (/hu/, /en/ … → /?lang=xx)
       ------------------------------------------------------------
       A statikus oldalak fölötti nyelvi gyökér ide irányít át. Ha
       megkaptuk a nyelvet, azt tekintjük mérvadónak: a látogató
       épp egy adott nyelvű oldalról jött, nem akarjuk felülírni
       geolokációval.

       KÉZI választásként tároljuk el (isManual = true), mert ez
       tudatos döntést tükröz – aki a német oldalon böngészett,
       az németül szeretné folytatni. A paramétert utána
       kitöröljük a címsorból. */
    const kertNyelv = new URLSearchParams(window.location.search).get('lang');
    // A támogatott nyelvek listáját a szótárból vesszük, nem külön
    // felsorolásból: így egy új nyelv felvételekor nincs második
    // hely, amit frissíteni kellene (és elfelejteni lehetne).
    if (kertNyelv && Object.prototype.hasOwnProperty.call(ADATLAP_SZOTAR, kertNyelv)) {
        window.history.replaceState({}, '', window.location.pathname);
        setLanguage(kertNyelv, null, true);
        return;
    }
...
function buildOrszagBlokk(iso) {
    ...
    return '<button class="tp-country" onclick="toggleCountryGroup(this)">'
         ...
         + '<span><span class="tp-count">' + tracks.length + ' ' + ui('trackCount') + '</span> <span class="tp-arrow">&#9654;</span></span>'
         + '</button>'
 ...
 */
/* A szekció-menüpontok VALÓDI linkek, ezért nincs szükség
   JS-navigációra. Csak a legördülő menüt zárjuk be, hogy
   visszalépéskor ne maradjon nyitva. */
/* A "Pályák" menüpont VALÓDI link a statikus listára (a keresőrobot
   miatt), de kattintásra a MEGSZOKOTT viselkedés marad: az oldalsó
   panel nyílik meg, oldalbetöltés nélkül.

   Kivétel: ha a látogató szándékosan új lapon nyitja (Ctrl/Cmd,
   Shift, középső gomb), nem avatkozunk be – akkor a statikus
   listaoldal jön be, ami helyes. */
function jumpTracksPanel(esemeny) {
    if (esemeny) {
        const ujLap = esemeny.ctrlKey || esemeny.metaKey ||
                      esemeny.shiftKey || esemeny.button === 1;
        if (ujLap) return true;
...
function szekcioMenuZar() {
    document.querySelectorAll('.dropdown-menu').forEach(m => m.classList.remove('open'));
}

/* A FŐMENÜ LINKJEINEK FRISSÍTÉSE
   ------------------------------------------------------------
   A menüpontok az index.html-ben VALÓDI <a href> linkek, nem
   gombok. Ennek oka SEO: a főoldal a legerősebb oldalunk, és a
   keresőrobot csak <a href>-et követ. Ha a menü gombokból állna,
   a statikus szekciók "árván" lógnának – csak a sitemapből
   derülne ki, hogy léteznek, ami sokkal gyengébb jelzés.

   A href-ben az alapértelmezett nyelv áll; itt írjuk át az
   aktuálisra. A robot a magyar változatot látja és onnan a
   hreflang alapján megtalálja a többit. */
function fomenuLinkekFrissit(nyelv) {
    document.querySelectorAll('[data-szekcio]').forEach(el => {
        const ut = el.getAttribute('data-szekcio');
        el.setAttribute('href', '/' + nyelv + '/' + ut + '/');
    });
}

/* Megtartva a visszafelé kompatibilitás miatt: ha valahol még a
   régi onclick="openHistoryMenu()" hívás maradna, az sem törik el. */
function openHistoryMenu() {
    szekcioMenuZar();
    window.location.href = '/' + (aktualisNyelv || 'hu') + '/history/';
}
...
/* A nyelvválasztó zászlóinak feltöltése – a DOM-ra vár. */
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', nyelvZaszlokFeltolt, { once: true });
} else {
    nyelvZaszlokFeltolt();
}
...
function syncDayNightButton() {
    ...
    const label = isNightMode ? ui('toDay') : ui('toNight');
    btn.title = label;
