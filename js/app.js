...
function setLanguage(code, btn, isManual = true) {
    ...
    /* ARAB (jobbról balra író) NYELV
       ------------------------------------------------------------
       A dir="rtl" a <html> elemre KORÁBBAN az EGÉSZ felületet
       tükrözte: a logó jobbra került, a gombok balra, vagyis a
       fejléc elrendezése megfordult. Ez nem kívánatos – a márka
       megjelenése és a megszokott gombhelyek nyelvfüggetlenek.

       Az arab írásirány a SZÖVEGRE vonatkozik, nem a felület
       felépítésére. Ezért a dir attribútumot a <body>-ra tesszük,
       a fejlécet pedig kivesszük alóla (dir="ltr"), így:
         · az arab szövegek helyesen, jobbról balra folynak,
         · a fejléc elrendezése változatlan marad minden nyelven. */
    const arab = (code === 'ar');
    document.documentElement.dir = 'ltr';
    document.body.dir = arab ? 'rtl' : 'ltr';
    const fejlecEl = document.querySelector('header');
    if (fejlecEl) fejlecEl.dir = 'ltr';
