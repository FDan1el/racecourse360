...
function buildPopupHtml(t, meta, orszagKod) {
    ...
    const directionText = DIRECTION_TEXT[t.direction] || "N/A";
    ...
    const ownSiteText = t.ownSite ? linkOf(t.ownSite) : "N/A";
    ...
    /* SZERVEZETI SOROK
       A szervezet TELJES NEVE a link FÖLÉ kerül, külön sorba - nem a
       végére sűrítve. Ennek az az oka, hogy a hivatalos nevek hosszúak
       (pl. "Société d'Encouragement à l'élevage du Trotteur Français"),
       és a link mögé zsúfolva olvashatatlanná préselődtek a keskeny
       adatlapon. Így viszont a név a saját sorában lélegzik, alatta
       pedig a kattintható cím. */
