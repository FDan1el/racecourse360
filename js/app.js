        ...
        <div class="popup-card">
            ...
            <div class="popup-body">${torzs}
                <div class="popup-row popup-adatlap">
                    <a href="${statikusUrl(orszagKod, t)}">Részletes adatlap &rsaquo;</a>
                </div>
            </div>
        </div>
    `;
...
const translations = {
    ...
    en: { back: "Back to the globe", legalTitle: "Privacy / Legal", menu: "Menu", lang: "Language",
          menuTracks: "Pályák", menuHistory: "History", menuAbout: "About us", menuContact: "Contact", instruction: "Enable the Trotting filter to reveal countries with racecourse data" },
    de: { back: "Zurück zum Globus", legalTitle: "Datenschutz / Impressum", menu: "Menü", lang: "Sprache",
          menuTracks: "Pályák", menuHistory: "Geschichte", menuAbout: "Über uns", menuContact: "Kontakt", instruction: "Aktiviere den Trab-Filter, um Länder mit Rennbahndaten anzuzeigen" },
    fr: { back: "Retour au globe", legalTitle: "Confidentialité / Mentions légales", menu: "Menu", lang: "Langue",
          menuTracks: "Pályák", menuHistory: "Histoire", menuAbout: "À propos", menuContact: "Contact", instruction: "Activez le filtre Trot pour afficher les pays avec des données" },
    sv: { back: "Tillbaka till jordgloben", legalTitle: "Integritet / Juridisk info", menu: "Meny", lang: "Språk",
          menuTracks: "Pályák", menuHistory: "Historia", menuAbout: "Om oss", menuContact: "Kontakt", instruction: "Aktivera travfiltret för att visa länder med banor" },
    es: { back: "Volver al globo", legalTitle: "Privacidad / Aviso legal", menu: "Menú", lang: "Idioma",
          menuTracks: "Pályák", menuHistory: "Historia", menuAbout: "Sobre nosotros", menuContact: "Contacto", instruction: "Activa el filtro de trote para mostrar los países con datos" },
    it: { back: "Torna al globo", legalTitle: "Privacy / Note legali", menu: "Menu", lang: "Lingua",
          menuTracks: "Pályák", menuHistory: "Storia", menuAbout: "Chi siamo", menuContact: "Contatti", instruction: "Attiva il filtro Trotto per mostrare i paesi con dati" },
    ja: { back: "地球儀に戻る", legalTitle: "プライバシー / 法的情報", menu: "メニュー", lang: "言語",
          menuTracks: "Pályák", menuHistory: "歴史", menuAbout: "私たちについて", menuContact: "お問い合わせ", instruction: "「速歩」フィルターをオンにすると、データのある国が表示されます" },
    zh: { back: "返回地球", legalTitle: "隐私 / 法律信息", menu: "菜单", lang: "语言",
          menuTracks: "Pályák", menuHistory: "历史", menuAbout: "关于我们", menuContact: "联系我们", instruction: "开启「快步」筛选以显示有数据的国家" },
    ar: { back: "العودة إلى الكرة الأرضية", legalTitle: "الخصوصية / قانوني", menu: "القائمة", lang: "اللغة",
          menuTracks: "Pályák", menuHistory: "التاريخ", menuAbout: "من نحن", menuContact: "اتصل بنا", instruction: "شغّل مرشح الهرولة لعرض الدول التي تتوفر لها بيانات" }
};
