...
//
//   earth-day.jpg   világos, nappali Föld-kép
//   earth-dark.jpg  sötét, éjszakai Föld-kép
//
// MEGJEGYZÉS: ezek a fájlnevek ellenőrzötten léteznek a CDN-en.
// Szebb alternatívák (earth-blue-marble.jpg, earth-night.jpg a
// városfényekkel) elvileg szintén elérhetők, de a nevük nem volt
// verifikálható – csak akkor cseréljük őket, ha előbb kipróbáltuk,
// hogy a kép tényleg betölt.
// ==========================================================
const TEX_BASE  = 'https://unpkg.com/three-globe/example/img/';
const TEX_DAY   = TEX_BASE + 'earth-day.jpg';
const TEX_NIGHT = TEX_BASE + 'earth-dark.jpg';
...
fetch('https://raw.githubusercontent.com/vasturiano/globe.gl/master/example/datasets/ne_110m_admin_0_countries.geojson')
    .then(res => res.json())
    .then(countries => { if (world) world.polygonsData(countries.features); })
